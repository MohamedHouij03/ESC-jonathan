...
const images = [
  {
    src: "/images/(All+Reformers)+E.S.C.P.+Full+Training+Manual (1).webp",
    alt: "E.S.C.P. Full Training Manual - All Reformers Reference",
  },
];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation
            currentLessonPath="/courses/level1-reformers/content/chapter-2/2-1"
            nextLessonPath="/courses/level1-reformers/content/chapter-2/2-2"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 className="text-4xl font-bold text-[#E43636] mb-2">Anatomy of Rectus Abdominis</h1>
              <p className="text-lg text-gray-600">Chapter 2 - Lesson 1</p>
            </motion.div>
            ...
            >
              ...
              >
                {activeTab === "description" && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Anatomy of Rectus Abdominis</h2>
      ...
      {isModalOpen && (
        <div
          className="fixed inset-0 bg-black/75 flex items-center justify-center z-50 p-4 overscroll-none"
          aria-modal="true"
          role="dialog"
        >
