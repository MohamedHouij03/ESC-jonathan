...
export default function Chapter24() {
  ...
  // Tab content data
  const resources = [
    { name: "Knee Strap Crunch Exercise Guide.pdf", size: "2.2MB", url: "/pdfs/ab wheel/knee strap crunch.pdf" },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation
            currentLessonPath="/courses/level1-reformers/content/chapter-2/2-4"
            nextLessonPath="/courses/level1-reformers/content/chapter-2/2-5"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 className="text-4xl font-bold text-[#E43636] mb-2">Knee Strap Crunch</h1>
              <p className="text-lg text-gray-600">Chapter 2 - Lesson 4</p>
            </motion.div>
            ...
            <iframe
              ...
              title="Knee Strap Crunch Tutorial"
              frameBorder="0"
            ...
            >
              ...
              >
                {activeTab === "description" && (
                        <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Knee Strap Crunch</h2>
                    <p className="text-gray-700">On the carriage, facing the back platform</p>
                </div>
              )}
                {activeTab === "resources" && (
                <div>
