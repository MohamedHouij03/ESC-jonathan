...
export default function Chapter23() {
  ...
  // Tab content data
  const resources = [
    { name: "Straight Arm Crunch Exercise Guide.pdf", size: "2.6MB", url: "/pdfs/ab wheel/straight arm crunch.pdf" },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation
            currentLessonPath="/courses/level1-reformers/content/chapter-2/2-3"
            nextLessonPath="/courses/level1-reformers/content/chapter-2/2-4"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 className="text-4xl font-bold text-[#E43636] mb-2">Straight Arm Crunch</h1>
              <p className="text-lg text-gray-600">Chapter 2 - Lesson 3</p>
            </motion.div>
            ...
            <iframe
              ...
              title="Straight Arm Crunch Exercise"
              frameBorder="0"
            ...
            >
              ...
              >
                {activeTab === "description" && (
                        <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Straight Arm Crunch</h2>
