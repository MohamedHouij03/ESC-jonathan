...
export default function Chapter25() {
  ...
  // Tab content data
  const resources = [
    { name: "Seated Crunch Exercise Guide.pdf", size: "203KB", url: "/pdfs/ab wheel/seated crunch/seated crunch.pdf" },
    { name: "Back Seated Crunch Exercise.pdf", size: "189KB", url: "/pdfs/ab wheel/seated crunch/back seated crunch.pdf" },
    { name: "Reverse Seated Crunch Exercise.pdf", size: "197KB", url: "/pdfs/ab wheel/seated crunch/reverse seated crunch.pdf" },
    { name: "Back Reverse Seated Crunch Exercise.pdf", size: "192KB", url: "/pdfs/ab wheel/seated crunch/back reverse seated crunch.pdf" },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation
            currentLessonPath="/courses/level1-reformers/content/chapter-2/2-5"
            nextLessonPath="/courses/level1-reformers/content/chapter-3/3-1"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 className="text-4xl font-bold text-[#E43636] mb-2">Seated Crunch</h1>
              <p className="text-lg text-gray-600">Chapter 2 - Lesson 5</p>
            </motion.div>
            ...
            >
              ...
              >
                {activeTab === "description" && (
                        <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Seated Crunch</h2>
