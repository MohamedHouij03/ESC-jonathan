...
export default function Chapter22() {
  ...
  // Tab content data
  const resources = [
    { name: "Kneeling Crunch Exercise Guide.pdf", size: "224KB", url: "/pdfs/ab wheel/kneeling crunch/kneeling crunch.pdf" },
    { name: "Back Kneeling Crunch Exercise.pdf", size: "259KB", url: "/pdfs/ab wheel/kneeling crunch/back kneeling crunch.pdf" },
    { name: "Reverse Kneeling Crunch Exercise.pdf", size: "237KB", url: "/pdfs/ab wheel/kneeling crunch/reverse kneeling crunch.pdf" },
    { name: "Back Reverse Kneeling Crunch Exercise.pdf", size: "201KB", url: "/pdfs/ab wheel/kneeling crunch/back reverse kneeling crunch.pdf" },
  ];
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-[#E2DDB4]">Chapter 2: Abdominal Exercises</p>
              </div>
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <CourseNavigation 
        currentLessonPath="/courses/level1-reformers/content/chapter-2/2-2"
        nextLessonPath="/courses/level1-reformers/content/chapter-2/2-3"
      />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 className="text-4xl font-bold text-[#E43636] mb-2">Kneeling Crunch (rainbow crunch)</h1>
              <p className="text-lg text-gray-600">Chapter 2 - Lesson 2</p>
            </motion.div>
            ...
            <iframe
              ...
              title="Abdominal Exercises Kneeling Crunch Tutorial"
              frameBorder="0"
            ...
            >
              ...
              >
                {activeTab === "description" && (
                        <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Kneeling Crunch (rainbow crunch)</h2>
                    <p className="text-gray-700">At the front, facing front</p>
                </div>
              )}
                {activeTab === "resources" && (
                <div>
