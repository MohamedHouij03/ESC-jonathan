...
export default function Chapter821() {
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-[#E2DDB4]">Chapter 7: Upper Body Exercises</p>
              </div>
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-8/8-21"
            nextLessonPath="/courses/level1-reformers/content/chapter-9/9-1"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-lg text-gray-600">Chapter 8 - Lesson 21</p>
            </motion.div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                          ...
                          <div className="order-1 lg:order-2">
                            <div className="space-y-6">
                              ...
                              <div className="bg-white p-4 rounded-lg border border-[#E43636]">
                                <h4 className="font-semibold text-[#E43636] mb-2">Grab</h4>
                                <p className="text-gray-700">On the <span className="font-semibold">{"{Long Black Straps}"}</span> and hold them by the <span className="font-semibold">{"{Short Hard Handles}"}</span></p>
                              </div>
                              
                              <div className="bg-white p-4 rounded-lg border border-[#E43636]">
                                <h4 className="font-semibold text-[#E43636] mb-2">Hands</h4>
                                <p className="text-gray-700">up and out in front of you up to your shoulders and hold</p>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="mt-20">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                          ...
                          <div className="order-1 lg:order-2">
                            <div className="space-y-6">
                              <div className="bg-white p-4 rounded-lg border border-[#E43636]">
                                <h4 className="font-semibold text-[#E43636] mb-2">Sit</h4>
                                <p className="text-gray-700">on the <span className="font-semibold">{"{Front Platform}"}</span> or <span className="font-semibold">{"{Carriage}"}</span> or <span className="font-semibold">{"{Back Platform}"}</span></p>
                              </div>
                              
                              <div className="bg-white p-4 rounded-lg border border-[#E43636]">
                                <h4 className="font-semibold text-[#E43636] mb-2">Grab</h4>
                                <p className="text-gray-700">The<span className="font-semibold">{"{Back Short Cables}"}</span></p>
                              </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                          ...
                          <div className="order-1 lg:order-2">
                            <div className="space-y-6">
                              ...
                              <div className="bg-white p-4 rounded-lg border border-[#E43636]">
                                <h4 className="font-semibold text-[#E43636] mb-2">Hands</h4>
                                <p className="text-gray-700">pull the Back <span className="font-semibold">{"{Short Cables}"}</span> up to Bicep Curl</p>
                              </div>
                            </div>
                          </div>
                        </div>
