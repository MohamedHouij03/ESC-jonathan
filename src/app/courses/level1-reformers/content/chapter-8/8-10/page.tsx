...
export default function Chapter810() {
  ...
  const resources = [
    { name: 'Forward Facing Bicep Curl Exercise Guide (PDF)', size: '2.6 MB', url: '/pdfs/ab wheel/Forward Facing Bicep Curl.pdf' },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-8/8-10"
            nextLessonPath="/courses/level1-reformers/content/chapter-8/8-11"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 className="text-4xl font-bold text-[#E43636] mb-2">Forward Facing Bicep Curl</h1>
              <p className="text-lg text-gray-600">Chapter 8 - Lesson 10</p>
            </motion.div>
            ...
            >
              <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
                <iframe
                  ...
                  title="Forward Facing Bicep Curl Tutorial"
                  frameBorder="0"
            ...
            >
              ...
              >
                {activeTab === 'description' && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Forward Facing Bicep Curl</h2>
                    <div className="space-y-3">
                      <p className="text-gray-700 leading-relaxed">
                        <span className="font-semibold text-[#E43636]">[right arm]</span>
                      </p>
                      <p className="text-gray-700 leading-relaxed">
