...
export default function Chapter812() {
  ...
  const resources = [
    { name: 'Carriage Seated Heavy Bicep Curl Exercise Guide (PDF)', size: '2.2 MB', url: '/pdfs/ab wheel/carriage seated heavy bicep curl.pdf' },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <CourseNavigation 
        currentLessonPath="/courses/level1-reformers/content/chapter-8/8-12"
        nextLessonPath="/courses/level1-reformers/content/chapter-8/8-13"
      />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 className="text-4xl font-bold text-[#E43636] mb-2">Carriage Seated Heavy Bicep Curl</h1>
              <p className="text-lg text-gray-600">Chapter 8 - Lesson 12</p>
            </motion.div>
            ...
            <iframe
              ...
              src="https://www.youtube.com/embed/jMcJyMcMRhY"
                  title="Carriage Seated Heavy Bicep Curl Tutorial"
              frameBorder="0"
            ...
            >
              {activeTab === 'description' && (
                <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Carriage Seated Heavy Bicep Curl</h2>
                    <p className="text-gray-700 leading-relaxed">
                      Sitting on the carriage, facing the back platform
                    </p>
                </div>
              )}
              {activeTab === 'resources' && (
