...
export default function Chapter32() {
  ...
  // Tab content data
  const resources = [
    { name: "Ab Wheel Exercise Guide (PDF)", size: "209 KB", url: "/pdfs/ab wheel/ab wheel/ab wheel.pdf" },
    { name: "Reverse Ab Wheel Exercise (PDF)", size: "210 KB", url: "/pdfs/ab wheel/ab wheel/reverse ab wheel.pdf" },
    { name: "Back Ab Wheel Exercise (PDF)", size: "197 KB", url: "/pdfs/ab wheel/ab wheel/back ab wheel.pdf" },
    { name: "Back Reverse Ab Wheel Exercise (PDF)", size: "196 KB", url: "/pdfs/ab wheel/ab wheel/back reverse ab wheel.pdf" },
    { name: "Flying Ab Wheel Exercise Guide (PDF)", size: "1.3MB", url: "/pdfs/ab wheel/flying ab wheel.pdf" },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation
            currentLessonPath="/courses/level1-reformers/content/chapter-3/3-2"
            nextLessonPath="/courses/level1-reformers/content/chapter-3/3-3"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 className="text-4xl font-bold text-[#E43636] mb-2">Ab Wheel</h1>
              <p className="text-lg text-gray-600">Chapter 3 - Lesson 2</p>
            </motion.div>
            ...
            <iframe
              ...
              title="Additional Ab Wheel Tutorial"
              frameBorder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
              allowFullScreen
            ></iframe>
            ...
            >
              ...
              >
                {activeTab === "description" && (
                        <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Ab Wheel</h2>
