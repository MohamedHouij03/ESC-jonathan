...
export default function Chapter34() {
  ...
  // Tab content data
  const resources = [
    { name: "Plank to Pike Exercise Guide (PDF)", size: "205 KB", url: "/pdfs/ab wheel/plank to pike/plank to pike.pdf" },
    { name: "Reverse Plank to Pike Exercise Guide (PDF)", size: "208 KB", url: "/pdfs/ab wheel/plank to pike/reverse plank to pike.pdf" },
    { name: "Back Plank to Pike Exercise Guide (PDF)", size: "200 KB", url: "/pdfs/ab wheel/plank to pike/back plank to pike.pdf" },
    { name: "Back Reverse Plank to Pike Exercise Guide (PDF)", size: "241 KB", url: "/pdfs/ab wheel/plank to pike/back reverse plank to pike.pdf" },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          {isClient && (
            <CourseNavigation 
              currentLessonPath="/courses/level1-reformers/content/chapter-3/3-4"
              nextLessonPath="/courses/level1-reformers/content/chapter-3/3-5"
            />
          )}
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-4xl font-bold text-[#E43636] mb-2">Plank to Pike & Forearm Plank to Pike</h1>
            <p className="text-lg text-gray-600">Chapter 3 - Lesson 4</p>
          </motion.div>
          ...
          >
              ...
              >
                ...
                {activeTab === "description" && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Plank to Pike & Forearm Plank to Pike</h2>
