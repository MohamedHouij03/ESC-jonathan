...
export default function Chapter33() {
  ...
  // Tab content data
  const resources = [
    { name: "Saw Exercise Guide (PDF)", size: "201 KB", url: "/pdfs/ab wheel/saw/saw.pdf" },
    { name: "Reverse Saw Exercise Guide (PDF)", size: "202 KB", url: "/pdfs/ab wheel/saw/reverse saw.pdf" },
    { name: "Back Saw Exercise Guide (PDF)", size: "195 KB", url: "/pdfs/ab wheel/saw/back saw.pdf" },
    { name: "Back Reverse Saw Exercise Guide (PDF)", size: "196 KB", url: "/pdfs/ab wheel/saw/back reverse saw.pdf" },
    { name: "Flying Saw Exercise Guide (PDF)", size: "1.4MB", url: "/pdfs/ab wheel/flying saw.pdf" },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          {isClient && (
            <CourseNavigation 
              currentLessonPath="/courses/level1-reformers/content/chapter-3/3-3"
              nextLessonPath="/courses/level1-reformers/content/chapter-3/3-4"
            />
          )}
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-4xl font-bold text-[#E43636] mb-2">Saw</h1>
            <p className="text-lg text-gray-600">Chapter 3 - Lesson 3</p>
          </motion.div>
          ...
          >
            <div className="bg-black rounded-2xl overflow-hidden shadow-2xl">
              <iframe
                ...
                title="Flying Saw Exercise - Additional Video"
                frameBorder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                allowFullScreen
                className="w-full"
          ...
          >
              ...
              >
                ...
                {activeTab === "description" && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Saw</h2>
