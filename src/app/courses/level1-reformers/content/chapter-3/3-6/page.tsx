...
export default function Chapter36() {
  ...
  // Tab content data
  const resources = [
    { name: "Reverse Boomerang Exercise Guide (PDF)", size: "2.1 MB", url: "/pdfs/ab wheel/reverse boomerang.pdf" },
    { name: "Back Boomerang Exercise Guide (PDF)", size: "1.8 MB", url: "/pdfs/ab wheel/back boomerang.pdf" },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          {isClient && (
            <CourseNavigation 
              currentLessonPath="/courses/level1-reformers/content/chapter-3/3-6"
              nextLessonPath="/courses/level1-reformers/content/chapter-3/3-7"
            />
          )}
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-4xl font-bold text-[#E43636] mb-2">Reverse Boomerang & Back Boomerang</h1>
            <p className="text-lg text-gray-600">Chapter 3 - Lesson 6</p>
          </motion.div>
          ...
          >
            <div className="bg-black rounded-2xl overflow-hidden shadow-2xl">
              <iframe
                ...
                title="Reverse Boomerang & Back Boomerang"
                frameBorder="0"
          ...
          >
              ...
              >
                ...
                {activeTab === "description" && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Reverse Boomerang & Back Boomerang</h2>
                    <p className="text-gray-700">In the back, facing the carriage.</p>
                  </div>
                )}
