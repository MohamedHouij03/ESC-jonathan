...
export default function Chapter37() {
  ...
  // Tab content data
  const resources = [
    { name: "Seal Exercise Guide (PDF)", size: "2.1 MB", url: "/pdfs/ab wheel/seal.pdf" },
    { name: "Reverse Seal Exercise Guide (PDF)", size: "1.8 MB", url: "/pdfs/ab wheel/reverse seal.pdf" },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          {isClient && (
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-3/3-7"
            nextLessonPath="/courses/level1-reformers/content/chapter-3/3-8"
          />
          )}
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-4xl font-bold text-[#E43636] mb-2">Seal & Reverse Seal</h1>
            <p className="text-lg text-gray-600">Chapter 3 - Lesson 7</p>
          </motion.div>
            ...
            >
              ...
              >
                ...
                {activeTab === "description" && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Seal & Reverse Seal</h2>
                    <p className="text-gray-700">In the front, facing back</p>
                  </div>
                )}
