...
export default function Chapter610() {
  ...
  const resources = [
    { name: "Heavy Single Leg Press (in Bridge Position) (PDF)", size: "2.2 MB", url: "/pdfs/ab wheel/heavy single leg press ( in bridge position).pdf" },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-6/6-10"
            nextLessonPath="/courses/level1-reformers/content/chapter-6/6-11"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-4xl font-bold text-[#E43636] mb-2">Heavy Single Leg Press (in Bridge Position)</h1>
            <p className="text-lg text-gray-600">Chapter 6 - Lesson 10</p>
          </motion.div>
          ...
          >
            <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
              <iframe
                ...
                src="https://www.youtube.com/embed/baWM0Q4iN2k"
                title="Heavy Single Leg Press in Bridge Position Tutorial"
                frameBorder="0"
          ...
          >
            ...
            >
              ...
              {activeTab === "description" && (
                <div>
                  <h2 className="text-2xl font-bold text-[#E43636] mb-4">Heavy Single Leg Press (in Bridge Position)</h2>
