...
export default function Chapter68() {
  ...
  const resources = [
    { name: "Donkey Kick (PDF)", size: "2.3 MB", url: "/pdfs/ab wheel/donkey kick.pdf" },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-6/6-8"
            nextLessonPath="/courses/level1-reformers/content/chapter-6/6-9"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-4xl font-bold text-[#E43636] mb-2">Donkey Kick</h1>
            <p className="text-lg text-gray-600">Chapter 6 - Lesson 8</p>
          </motion.div>
          ...
          >
            ...
            >
              ...
              {activeTab === "description" && (
                <div>
                  <h2 className="text-2xl font-bold text-[#E43636] mb-4">Donkey Kick</h2>
