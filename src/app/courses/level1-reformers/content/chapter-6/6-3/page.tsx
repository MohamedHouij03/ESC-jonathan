...
export default function Chapter63() {
  ...
  const resources = [
    { name: "Skater (PDF)", size: "1.1 MB", url: "/pdfs/ab wheel/skater.pdf" },
    { name: "Shifted Skater (PDF)", size: "1.2 MB", url: "/pdfs/ab wheel/shifted skater.pdf" },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-6/6-3"
            nextLessonPath="/courses/level1-reformers/content/chapter-6/6-4"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-4xl font-bold text-[#E43636] mb-2">Skater and Shifted Skater</h1>
            <p className="text-lg text-gray-600">Chapter 6 - Lesson 3</p>
          </motion.div>
          ...
          >
            <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
              <iframe
                className="absolute top-0 left-0 w-full h-full"
                src="https://www.youtube.com/embed/4mq7j415tuc"
                title="Shifted Skater - Additional Tutorial"
                frameBorder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
              ></iframe>
          ...
          >
            ...
            >
              ...
              {activeTab === "description" && (
                <div>
                  <h2 className="text-2xl font-bold text-[#E43636] mb-4">Skater and Shifted Skater</h2>
