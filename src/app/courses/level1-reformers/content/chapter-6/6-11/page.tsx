...
export default function Chapter611() {
  ...
  const resources = [
    { name: "Scooter Kick (PDF)", size: "2.1 MB", url: "/pdfs/ab wheel/scooter kick.pdf" },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-6/6-11"
            nextLessonPath="/courses/level1-reformers/content/chapter-6/6-12"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-4xl font-bold text-[#E43636] mb-2">Scooter Kick</h1>
            <p className="text-lg text-gray-600">Chapter 6 - Lesson 11</p>
          </motion.div>
          ...
          >
            ...
            >
              ...
              {activeTab === "description" && (
                <div>
                  <h2 className="text-2xl font-bold text-[#E43636] mb-4">Scooter Kick</h2>
