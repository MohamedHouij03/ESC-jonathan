...
export default function Chapter69() {
  ...
  const resources = [
    { name: "Side Laying Leg Press (PDF)", size: "2.4 MB", url: "/pdfs/ab wheel/side laying leg press.pdf" },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-6/6-9"
            nextLessonPath="/courses/level1-reformers/content/chapter-6/6-10"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-4xl font-bold text-[#E43636] mb-2">Side Laying Leg Press</h1>
            <p className="text-lg text-gray-600">Chapter 6 - Lesson 9</p>
          </motion.div>
          ...
          >
            <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
              <iframe
                ...
                title="Side Laying Leg Press Tutorial"
                frameBorder="0"
          ...
          >
            ...
            >
              ...
              {activeTab === "description" && (
                <div>
                  <h2 className="text-2xl font-bold text-[#E43636] mb-4">Side Laying Leg Press</h2>
                  <div className="space-y-4">
                    <p className="text-gray-700 leading-relaxed">
                      [left leg]<br />
                      Laying on the Carriage, facing sideways
                    </p>
                  </div>
                </div>
              )}
