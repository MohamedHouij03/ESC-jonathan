...
export default function Chapter612() {
  ...
  const resources = [
    { name: "Heavy Carriage Lunge WROW (PDF)", size: "2.3 MB", url: "/pdfs/ab wheel/Heavy Carriage Lunge WROW.pdf" },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-6/6-12"
            nextLessonPath="/courses/level1-reformers/content/chapter-6/6-13"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-4xl font-bold text-[#E43636] mb-2">Heavy Carriage Lunge W\ ROW</h1>
            <p className="text-lg text-gray-600">Chapter 6 - Lesson 12</p>
          </motion.div>
          ...
          >
            <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
              <iframe
                ...
                src="https://www.youtube.com/embed/Bh-gEFOnhtE"
                title="Heavy Carriage Lunge WROW Tutorial"
                frameBorder="0"
          ...
          >
            <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
              <iframe
                ...
                title="Additional Heavy Carriage Lunge WROW Exercises Video"
                frameBorder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
              ></iframe>
          ...
          >
            ...
            >
              ...
              {activeTab === "description" && (
                <div>
                  <h2 className="text-2xl font-bold text-[#E43636] mb-4">Heavy Carriage Lunge W\ ROW</h2>
