...
export default function Chapter66() {
  ...
  const resources = [
    { name: "Black Widow (PDF)", size: "2.1 MB", url: "/pdfs/ab wheel/black widow.pdf" },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-6/6-6"
            nextLessonPath="/courses/level1-reformers/content/chapter-6/6-7"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-4xl font-bold text-[#E43636] mb-2">Black Widow</h1>
            <p className="text-lg text-gray-600">Chapter 6 - Lesson 6</p>
          </motion.div>
          ...
          >
            ...
            >
              ...
              {activeTab === "description" && (
                <div>
                  <h2 className="text-2xl font-bold text-[#E43636] mb-4">Black Widow</h2>
                  <div className="space-y-4">
                    <p className="text-gray-700 leading-relaxed">
                      [left leg]<br />
                      On the carriage, facing the sideways
                    </p>
                  </div>
                </div>
              )}
