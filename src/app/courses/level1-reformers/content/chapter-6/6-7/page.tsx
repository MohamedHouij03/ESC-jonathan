...
export default function Chapter67() {
  ...
  const resources = [
    { name: "Praying Mantis (PDF)", size: "2.1 MB", url: "/pdfs/ab wheel/Praying Mantis.pdf" },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-6/6-7"
            nextLessonPath="/courses/level1-reformers/content/chapter-6/6-8"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-4xl font-bold text-[#E43636] mb-2">Praying Mantis</h1>
            <p className="text-lg text-gray-600">Chapter 6 - Lesson 7</p>
          </motion.div>
          ...
          >
            <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
              <iframe
                ...
                title="Additional Praying Mantis Exercises Video"
                frameBorder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
              ></iframe>
          ...
          >
            <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
              <iframe
                className="absolute top-0 left-0 w-full h-full"
                src="https://www.youtube.com/embed/sQ-QkDr-4eY"
                title="Advanced Praying Mantis Techniques Video"
                frameBorder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
              ></iframe>
          ...
          >
            ...
            >
              ...
              {activeTab === "description" && (
                <div>
                  <h2 className="text-2xl font-bold text-[#E43636] mb-4">Praying Mantis</h2>
                  <div className="space-y-4">
                    <p className="text-gray-700 leading-relaxed">
                      [right leg]<br />
                      On the right side of the carriage, facing the front platform
                    </p>
                  </div>
                </div>
              )}
