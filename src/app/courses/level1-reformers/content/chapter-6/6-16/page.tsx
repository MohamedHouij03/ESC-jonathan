...
export default function Chapter616() {
  ...
  const images = [
    { src: "/images/6-21/aaa.jpg", alt: "Practicing Cues reference 1" },
    { src: "/images/6-21/bbb.jpg", alt: "Practicing Cues reference 2" },
    { src: "/images/6-21/IMG_4837.jpg", alt: "Practicing Cues reference 3" },
    { src: "/images/6-21/ssss.jpg", alt: "Practicing Cues reference 4" },
    { src: "/images/6-21/z.jpg", alt: "Practicing Cues reference 5" },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-6/6-16"
            nextLessonPath="/courses/level1-reformers/content/chapter-7/7-1"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 className="text-4xl font-bold text-[#E43636] mb-2">Leg Block — Practicing Cues</h1>
              <p className="text-lg text-gray-600">Chapter 6 - Lesson 16</p>
            </motion.div>
                      ...
                      {idx === 0 && (
                        <div className="space-y-3">
                          ...
                          <div>
                            ...
                            <p>behind you on the {'{'}Front Platform{'}'} or {'{'}Carriage{'}'} or {'{'}Back Platform{'}'}</p>
                          </div>
                          <div>
                            <p className="font-semibold">Gaze</p>
                            <p>is forward with your chest tall and proud.</p>
                          </div>
                        </div>
                      )}
                      {idx === 1 && (
                        <div className="space-y-3">
                          <div>
                            <p className="font-semibold">Left Foot</p>
                            <p>on the {'{'}Front Platform{'}'} or {'{'}Carriage{'}'} or {'{'}Back Platform{'}'} all the way forward to the edge</p>
                          </div>
                          <div>
                            <p className="font-semibold">Right Foot</p>
                            <p>diagonally behind you on the {'{'}Front Platform{'}'} or {'{'}Carriage{'}'} or {'{'}Back Platform{'}'} with your toes down and heels up</p>
                          </div>
                          <div>
                            <p className="font-semibold">Send</p>
                            <p>your hips back as you bend your left knee to come down.</p>
                          </div>
                        </div>
                      )}
                      {idx === 2 && (
                        <div className="space-y-3">
                          <div>
                            ...
                            <p>at the edge of the {'{'}Front Platform{'}'} or {'{'}Carriage{'}'} or {'{'}Back Platform{'}'} turn the “black handlebars” inward, and legs go over the bars to scoot forward</p>
                          </div>
                          <div>
                            <p className="font-semibold">Lay down</p>
                            <p>on your back, heels up onto the {'{'}front platform{'}'} and hold onto the edge of the moving carriage</p>
                          </div>
                          <div>
                            <p className="font-semibold">Lift up</p>
                            <p>your hips into a bridge position and engage the core</p>
                          </div>
                        </div>
                      )}
                      {idx === 3 && (
                        <div className="space-y-3">
                          <div>
                            <p className="font-semibold">Kneel</p>
                            <p>at the center of the {'{'}Front Platform{'}'} or {'{'}Carriage{'}'} or {'{'}Back Platform{'}'}</p>
                          </div>
                          <div>
                            <p className="font-semibold">Tuck</p>
                            <p>the toes and balls of your right foot up against the {'{'}front carriage strap{'}'}</p>
                          </div>
                          <div>
                            <p className="font-semibold">Left Foot</p>
                            <p>up against the {'{'}black handlebar{'}'} that’s turned outwards</p>
                          </div>
                        </div>
                      )}
                      {idx === 4 && (
            ...
            >
              ...
              >
                {activeTab === "description" && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Leg Block — Practicing Cues</h2>
                    <div className="space-y-6 text-[#000000]">
                      ...
                      <p className="italic">(Practice the above two everyday)</p>
                      <p className="text-sm opacity-80">Start with this in the beginning.</p>
                    </div>
                  </div>
                )}
                {activeTab === "resources" && (
