...
export default function Chapter55() {
  ...
  const resources = [
    { name: "Back Light Squats Exercise Guide (PDF)", size: "2.0 MB", url: "/pdfs/ab wheel/Back Light Squats.pdf" },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-5/5-5"
            nextLessonPath="/courses/level1-reformers/content/chapter-5/5-6"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-4xl font-bold text-[#E43636] mb-2">Back Light Squats</h1>
            <p className="text-lg text-gray-600">Chapter 5 - Lesson 5</p>
          </motion.div>
          ...
          >
            <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
              <iframe
                ...
                title="Back Light Squats Tutorial"
                frameBorder="0"
          ...
          >
              ...
              >
                ...
                {activeTab === "description" && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Back Light Squats</h2>
