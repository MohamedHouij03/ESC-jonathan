...
export default function Chapter56() {
  ...
  const resources = [
    { name: "Back Standing Inner Thigh Exercise Guide (PDF)", size: "2.2 MB", url: "/pdfs/ab wheel/back standing inner thigh.pdf" },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation
            currentLessonPath="/courses/level1-reformers/content/chapter-5/5-6"
            nextLessonPath="/courses/level1-reformers/content/chapter-5/5-7"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-4xl font-bold text-[#E43636] mb-2">Back Standing Inner Thigh</h1>
            <p className="text-lg text-gray-600">Chapter 5 - Lesson 6</p>
          </motion.div>
          ...
          >
            <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
              <iframe
                ...
                src="https://www.youtube.com/embed/m85a0y2E7R8"
                title="Back Standing Inner Thigh Tutorial"
                frameBorder="0"
          ...
          >
            ...
            >
              ...
              {activeTab === "description" && (
                <div>
                  <h2 className="text-2xl font-bold text-[#E43636] mb-4">Back Standing Inner Thigh</h2>
