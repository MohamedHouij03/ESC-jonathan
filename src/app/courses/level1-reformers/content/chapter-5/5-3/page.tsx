...
export default function Chapter53() {
  ...
  const resources = [
    { name: "Back Carriage Lunge Exercise Guide (PDF)", size: "2.2 MB", url: "/pdfs/ab wheel/back carriage lunge (2).pdf" },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-5/5-3"
            nextLessonPath="/courses/level1-reformers/content/chapter-5/5-4"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-4xl font-bold text-[#E43636] mb-2">Back Carriage Lunge</h1>
            <p className="text-lg text-gray-600">Chapter 5 - Lesson 3</p>
          </motion.div>
          ...
          >
            <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
              <iframe
                ...
                title="Back Carriage Lunge Tutorial"
                frameBorder="0"
          ...
          >
            <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
              <iframe
                className="absolute top-0 left-0 w-full h-full"
                src="https://www.youtube.com/embed/MxVzKRhSx5k"
                title="Back Carriage Lunge - Additional Tutorial"
                frameBorder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
              ></iframe>
          ...
          >
              ...
              >
                ...
                {activeTab === "description" && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Back Carriage Lunge</h2>
                    <div className="space-y-4">
                      <p className="text-gray-700 leading-relaxed">
                        [right leg]<br />
                        In the back, facing front
                      </p>
                    </div>
                  </div>
                )}
