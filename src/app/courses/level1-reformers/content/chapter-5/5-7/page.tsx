...
export default function Chapter57() {
  ...
  const resources = [
    { name: "Well Lunge Exercise Guide (PDF)", size: "2.6 MB", url: "/pdfs/ab wheel/well lunge.pdf" },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation
            currentLessonPath="/courses/level1-reformers/content/chapter-5/5-7"
            nextLessonPath="/courses/level1-reformers/content/chapter-5/5-8"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-4xl font-bold text-[#E43636] mb-2">Well Lunge</h1>
            <p className="text-lg text-gray-600">Chapter 5 - Lesson 7</p>
          </motion.div>
          ...
          >
            <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
              <iframe
                className="absolute top-0 left-0 w-full h-full"
                src="https://www.youtube.com/embed/DUE9VCHeLPA"
                title="Well Lunge - Additional Tutorial"
                frameBorder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
              ></iframe>
          ...
          >
            <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
              <iframe
                className="absolute top-0 left-0 w-full h-full"
                src="https://www.youtube.com/embed/WvS498SmNcc"
                title="Well Lunge - Advanced Techniques"
                frameBorder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
              ></iframe>
          ...
          >
            ...
            >
              ...
              {activeTab === "description" && (
                <div>
                  <h2 className="text-2xl font-bold text-[#E43636] mb-4">Well Lunge</h2>
                  <div className="space-y-4">
                    <p className="text-gray-700 leading-relaxed">
                      [right leg]<br />
                      In the well, facing back
                    </p>
                  </div>
                </div>
              )}
