...
export default function Chapter715() {
  ...
  const resources = [
    { name: 'Bow and Arrow Exercise Guide (PDF)', size: '2.5 MB', url: '/pdfs/ab wheel/bow and arrow.pdf' },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-7/7-15"
            nextLessonPath="/courses/level1-reformers/content/chapter-7/7-16"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 className="text-4xl font-bold text-[#E43636] mb-2">Bow and Arrow</h1>
              <p className="text-lg text-gray-600">Chapter 7 - Lesson 15</p>
            </motion.div>
            ...
            >
              <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
                <iframe
                  ...
                  src="https://www.youtube.com/embed/PsnvriDV6Dw"
                  title="Bow and Arrow Tutorial"
                  frameBorder="0"
            ...
            >
              ...
              >
                {activeTab === 'description' && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Bow and Arrow</h2>
