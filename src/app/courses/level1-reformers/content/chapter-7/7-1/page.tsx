    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-7/7-1"
            nextLessonPath="/courses/level1-reformers/content/chapter-7/7-2"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-4xl font-bold text-[#E43636] mb-2">Torse Twist 1.0 & 2.0</h1>
            <p className="text-lg text-gray-600">Chapter 7 - Lesson 1</p>
          </motion.div>
          ...
          >
            <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
              <iframe
                ...
                title="Oblique Exercises Tutorial"
                frameBorder="0"
          ...
          >
            <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
              <iframe
                className="absolute top-0 left-0 w-full h-full"
                src="https://www.youtube.com/embed/6_LsZ2DCPn4"
                title="Additional Oblique Exercises Video"
                frameBorder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
              ></iframe>
          ...
          >
              ...
              >
                {activeTab === 'description' && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Torse Twist 1.0 & 2.0</h2>
                    <p className="text-gray-700 leading-relaxed">
                      [left oblique]<br />
                      On the carriage, facing sideways
                    </p>
                  </div>
                )}
                {activeTab === 'resources' && (
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {[
                        { name: 'Torso Twist 1.0 Exercise Guide (PDF)', size: '2.1 MB', url: '/pdfs/ab wheel/torso twist 1.0.pdf' },
                        { name: 'Torso Twist 2.0 Exercise Guide (PDF)', size: '2.3 MB', url: '/pdfs/ab wheel/torso twist 2.0.pdf' },
                      ].map((r, i) => (
                        <div
                          key={i}
