...
export default function Chapter76() {
  ...
  const resources = [
    { name: 'Twister Exercise Guide (PDF)', size: '2.2 MB', url: '/pdfs/ab wheel/twister.pdf' },
    { name: 'Back Reverse Twister Exercise Guide (PDF)', size: '2.4 MB', url: '/pdfs/ab wheel/back reverse twister.pdf' },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-7/7-6"
            nextLessonPath="/courses/level1-reformers/content/chapter-7/7-7"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 className="text-4xl font-bold text-[#E43636] mb-2">Twister</h1>
              <p className="text-lg text-gray-600">Chapter 7 - Lesson 6</p>
            </motion.div>
            ...
            >
              <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
                <iframe
                  ...
                  title="Twister - Additional Tutorial"
                  frameBorder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                  allowFullScreen
                ></iframe>
            ...
            >
              ...
              >
                {activeTab === 'description' && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Twister</h2>
                    <p className="text-gray-700 leading-relaxed">
                      [right oblique]<br />
                      At the front, facing front<br />
                      <br />
                      <strong>Note:</strong> This exercise is the only crossed-leg exercise on the heel
                    </p>
                  </div>
                )}
                {activeTab === 'resources' && (
