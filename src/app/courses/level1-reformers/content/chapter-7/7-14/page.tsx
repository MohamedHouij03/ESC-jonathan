...
export default function Chapter714() {
  ...
  const resources = [
    { name: 'Mermaid Crunch Exercise Guide (PDF)', size: '1.8 MB', url: '/pdfs/ab wheel/mermaid crunch.pdf' },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-7/7-14"
            nextLessonPath="/courses/level1-reformers/content/chapter-7/7-15"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 className="text-4xl font-bold text-[#E43636] mb-2">Mermaid Crunch</h1>
              <p className="text-lg text-gray-600">Chapter 7 - Lesson 14</p>
            </motion.div>
            ...
            >
              ...
              >
                {activeTab === 'description' && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Mermaid Crunch</h2>
                    <p className="text-gray-700 leading-relaxed">
                      [left oblique]<br />
                      Seated on the back platform, facing sideways
                    </p>
                  </div>
                )}
                {activeTab === 'resources' && (
