...
export default function Chapter77() {
  ...
  const resources = [
    { name: 'Bicycle Kicks Exercise Guide (PDF)', size: '2.4 MB', url: '/pdfs/ab wheel/bicycle kicks/bicycle kicks.pdf' },
    { name: 'Back Bicycle Kicks Exercise Guide (PDF)', size: '2.5 MB', url: '/pdfs/ab wheel/bicycle kicks/back bicycle kicks.pdf' },
    { name: 'Reverse Bicycle Kicks Exercise Guide (PDF)', size: '2.4 MB', url: '/pdfs/ab wheel/bicycle kicks/reverse bicycle kicks.pdf' },
    { name: 'Back Reverse Bicycle Kicks Exercise Guide (PDF)', size: '2.2 MB', url: '/pdfs/ab wheel/bicycle kicks/back reverse bicycle kicks.pdf' },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-7/7-7"
            nextLessonPath="/courses/level1-reformers/content/chapter-7/7-8"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 className="text-4xl font-bold text-[#E43636] mb-2">Bicycle Kicks</h1>
              <p className="text-lg text-gray-600">Chapter 7 - Lesson 7</p>
            </motion.div>
            ...
            >
              ...
              >
                {activeTab === 'description' && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Bicycle Kicks</h2>
