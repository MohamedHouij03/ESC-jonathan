...
export default function Chapter73() {
  ...
  const resources = [
    { name: 'Oblique Kickback (Advanced Exercise) Guide (PDF)', size: '2.3 MB', url: '/pdfs/ab wheel/oblique kickback (advanced exercise).pdf' },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-7/7-3"
            nextLessonPath="/courses/level1-reformers/content/chapter-7/7-4"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 className="text-4xl font-bold text-[#E43636] mb-2">Oblique Kickback</h1>
              <p className="text-lg text-gray-600">Chapter 7 - Lesson 3</p>
            </motion.div>
            ...
            >
              ...
              >
                {activeTab === 'description' && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Oblique Kickback</h2>
                    <p className="text-gray-700 leading-relaxed">
                      [right oblique]<br />
                      On the carriage, facing the back platform<br />
                      <br />
                      <strong>Video timing:</strong> Start video at 2:27
                    </p>
                  </div>
                )}
                {activeTab === 'resources' && (
