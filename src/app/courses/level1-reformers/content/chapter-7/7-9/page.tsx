...
export default function Chapter79() {
  ...
  const resources = [
    { name: 'Nighthawk Exercise Guide (PDF)', size: '1.7 MB', url: '/pdfs/ab wheel/nighthawk/nighthawk.pdf' },
    { name: 'Back Nighthawk Exercise Guide (PDF)', size: '1.7 MB', url: '/pdfs/ab wheel/nighthawk/back nighthawk.pdf' },
    { name: 'Reverse Nighthawk Exercise Guide (PDF)', size: '1.8 MB', url: '/pdfs/ab wheel/nighthawk/reverse nighthawk.pdf' },
    { name: 'Back Reverse Nighthawk Exercise Guide (PDF)', size: '1.7 MB', url: '/pdfs/ab wheel/nighthawk/back reverse nighthawk.pdf' },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-7/7-9"
            nextLessonPath="/courses/level1-reformers/content/chapter-7/7-10"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 className="text-4xl font-bold text-[#E43636] mb-2">Nighthawk</h1>
              <p className="text-lg text-gray-600">Chapter 7 - Lesson 9</p>
            </motion.div>
            ...
            >
              ...
              >
                {activeTab === 'description' && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Nighthawk</h2>
