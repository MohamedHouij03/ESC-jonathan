...
export default function Chapter716() {
  ...
  const resources = [
    { name: 'Twisted Forearm Plank to Pike Exercise Guide (PDF)', size: '2.0 MB', url: '/pdfs/ab wheel/twisted forearm plank to pike/twisted forearm plank to pike.pdf' },
    { name: 'Reverse Twisted Forearm Plank to Pike Exercise Guide (PDF)', size: '2.1 MB', url: '/pdfs/ab wheel/twisted forearm plank to pike/reverse twisted forearm plank to pike.pdf' },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-7/7-16"
            nextLessonPath="/courses/level1-reformers/content/chapter-7/7-17"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 className="text-4xl font-bold text-[#E43636] mb-2">Twisted Forearm Plank to Pike</h1>
              <p className="text-lg text-gray-600">Chapter 7 - Lesson 16</p>
            </motion.div>
            ...
            >
              <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
                <iframe
                  ...
                  title="Twisted Forearm Plank to Pike Tutorial"
                  frameBorder="0"
            ...
            >
              ...
              >
                {activeTab === 'description' && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Twisted Forearm Plank to Pike</h2>
                    <p className="text-gray-700 leading-relaxed">
                      [side of Carriage] [left oblique]<br />
                      standing on the left side of the carriage, facing the front platform
                    </p>
                  </div>
                )}
                {activeTab === 'resources' && (
