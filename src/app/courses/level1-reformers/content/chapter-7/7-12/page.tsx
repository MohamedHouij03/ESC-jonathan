...
export default function Chapter712() {
  ...
  const resources = [
    { name: 'Twisted Saw Exercise Guide (PDF)', size: '2.0 MB', url: '/pdfs/ab wheel/twisted saw/twisted saw.pdf' },
    { name: 'Back Twisted Saw Exercise Guide (PDF)', size: '1.9 MB', url: '/pdfs/ab wheel/twisted saw/back twisted saw.pdf' },
    { name: 'Reverse Twisted Saw Exercise Guide (PDF)', size: '2.1 MB', url: '/pdfs/ab wheel/twisted saw/reverse twisted saw.pdf' },
    { name: 'Back Reverse Twisted Saw Exercise Guide (PDF)', size: '1.9 MB', url: '/pdfs/ab wheel/twisted saw/back reverse twisted saw.pdf' },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-7/7-12"
            nextLessonPath="/courses/level1-reformers/content/chapter-7/7-13"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 className="text-4xl font-bold text-[#E43636] mb-2">Twisted Saw</h1>
              <p className="text-lg text-gray-600">Chapter 7 - Lesson 12</p>
            </motion.div>
            ...
            >
              <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
                <iframe
                  className="absolute top-0 left-0 w-full h-full"
                  src="https://www.youtube.com/embed/cpDDQ0tDTjI"
                  title="Twisted Saw - Additional Tutorial"
                  frameBorder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                  allowFullScreen
                ></iframe>
            ...
            >
              ...
              >
                {activeTab === 'description' && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Twisted Saw</h2>
