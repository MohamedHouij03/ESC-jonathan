...
export default function Chapter713() {
  ...
  const resources = [
    { name: 'Dancing Panther Exercise Guide (PDF)', size: '2.0 MB', url: '/pdfs/ab wheel/dancing panther/dancing panther.pdf' },
    { name: 'Back Dancing Panther Exercise Guide (PDF)', size: '1.9 MB', url: '/pdfs/ab wheel/dancing panther/back dancing panther.pdf' },
    { name: 'Reverse Dancing Panther Exercise Guide (PDF)', size: '2.0 MB', url: '/pdfs/ab wheel/dancing panther/reverse dancing panther.pdf' },
    { name: 'Back Reverse Dancing Panther Exercise Guide (PDF)', size: '1.9 MB', url: '/pdfs/ab wheel/dancing panther/back reverse dancing panther.pdf' },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-7/7-13"
            nextLessonPath="/courses/level1-reformers/content/chapter-7/7-14"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 className="text-4xl font-bold text-[#E43636] mb-2">Dancing Panther</h1>
              <p className="text-lg text-gray-600">Chapter 7 - Lesson 13</p>
            </motion.div>
            ...
            >
              <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
                <iframe
                  ...
                  title="Dancing Panther Tutorial"
                  frameBorder="0"
            ...
            >
              ...
              >
                {activeTab === 'description' && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Dancing Panther</h2>
