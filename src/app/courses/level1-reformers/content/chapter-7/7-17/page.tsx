...
export default function Chapter717() {
  ...
  const resources = [
    { name: 'Bird Dog Exercise Guide (PDF)', size: '1.8 MB', url: '/pdfs/ab wheel/bird dog.pdf' },
    { name: 'Reverse Bird Dog Exercise Guide (PDF)', size: '1.8 MB', url: '/pdfs/ab wheel/reverse bird dog.pdf' },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-7/7-17"
            nextLessonPath="/courses/level1-reformers/content/chapter-7/7-18"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 className="text-4xl font-bold text-[#E43636] mb-2">Bird Dog and Reverse Bird Dog</h1>
              <p className="text-lg text-gray-600">Chapter 7 - Lesson 17</p>
            </motion.div>
            ...
            >
              <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
                <iframe
                  className="absolute top-0 left-0 w-full h-full"
                  src="https://www.youtube.com/embed/3f_lI_ijbU4"
                  title="Bird Dog and Reverse Bird Dog - Additional Tutorial"
                  frameBorder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                  allowFullScreen
                ></iframe>
            ...
            >
              <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
                <iframe
                  ...
                  title="Bird Dog and Reverse Bird Dog - Advanced Tutorial"
                  frameBorder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                  allowFullScreen
                ></iframe>
            ...
            >
              ...
              >
                {activeTab === 'description' && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Bird Dog and Reverse Bird Dog</h2>
