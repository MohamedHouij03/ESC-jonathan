...
export default function Chapter43() {
  ...
  const resources = [
    { name: "Carriage Lunge Exercise Guide (PDF)", size: "2.0 MB", url: "/pdfs/ab wheel/carriage lunge.pdf" },
    { name: "Back Carriage Lunge Exercise Guide (PDF)", size: "2.1 MB", url: "/pdfs/ab wheel/back carriage lunge.pdf" },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-4/4-3"
            nextLessonPath="/courses/level1-reformers/content/chapter-4/4-4"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-4xl font-bold text-[#E43636] mb-2">Carriage Lunge</h1>
            <p className="text-lg text-gray-600">Chapter 4 - Lesson 3</p>
          </motion.div>
          ...
          >
              ...
              >
                ...
                {activeTab === "description" && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Carriage Lunge</h2>
