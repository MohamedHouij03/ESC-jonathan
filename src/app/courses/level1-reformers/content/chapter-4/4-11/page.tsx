...
export default function Chapter411() {
  ...
  const resources = [
    { name: "Platform Single Leg Hamstring Curl Exercise Guide (PDF)", size: "2.9 MB", url: "/pdfs/ab wheel/platform single leg hamstring curl.pdf" },
    { name: "Handlebar Single Leg Hamstring Curl Exercise Guide (PDF)", size: "2.9 MB", url: "/pdfs/ab wheel/handlebar single leg hamstring curl.pdf" },
  ];
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-[#E2DDB4]">Chapter 4: Light Leg Exercises</p>
              </div>
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-4/4-11"
            nextLessonPath="/courses/level1-reformers/content/chapter-5/5-1"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-4xl font-bold text-[#E43636] mb-2">Hamstring Curl (and Single Leg Hamstring Curl)</h1>
            <p className="text-lg text-gray-600">Chapter 4 - Lesson 11</p>
          </motion.div>
          ...
          >
            <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
              <iframe
                ...
                src="https://youtube.com/embed/Wi9qySAQCao"
                title="Hamstring Curl Tutorial"
                frameBorder="0"
          ...
          >
              ...
              >
                ...
                {activeTab === "description" && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Hamstring Curl (and Single Leg Hamstring Curl)</h2>
                    <div className="space-y-4">
                      <p className="text-gray-700 leading-relaxed">
                        [right leg]<br />
                        On the carriage, facing the front platform
                      </p>
                    </div>
                  </div>
                )}
