...
export default function Chapter46() {
  ...
  const resources = [
    { name: "Light Squat Exercise Guide (PDF)", size: "2.1 MB", url: "/pdfs/ab wheel/light squat.pdf" },
    { name: "Back Light Squat Exercise Guide (PDF)", size: "2.0 MB", url: "/pdfs/ab wheel/back light squat.pdf" },
    { name: "Back Single Leg Squat Exercise Guide (PDF)", size: "2.2 MB", url: "/pdfs/ab wheel/back single leg squat.pdf" },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-4/4-6"
            nextLessonPath="/courses/level1-reformers/content/chapter-4/4-7"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-4xl font-bold text-[#E43636] mb-2">Light Squats</h1>
            <p className="text-lg text-gray-600">Chapter 4 - Lesson 6</p>
          </motion.div>
          ...
          >
            <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
              <iframe
                ...
                src="https://www.youtube.com/embed/rMzUYppjmcc"
                title="Light Squats Tutorial"
                frameBorder="0"
          ...
          >
            <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
              <iframe
                className="absolute top-0 left-0 w-full h-full"
                src="https://www.youtube.com/embed/AflxQH_h6fg"
                title="Light Squats - Additional Tutorial"
                frameBorder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
              ></iframe>
          ...
          >
              ...
              >
                ...
                {activeTab === "description" && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Light Squats</h2>
