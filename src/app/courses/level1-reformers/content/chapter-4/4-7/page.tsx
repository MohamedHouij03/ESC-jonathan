...
export default function Chapter47() {
  ...
  const resources = [
    { name: "Curtsy Lunge Exercise Guide (PDF)", size: "364 KB", url: "/pdfs/ab wheel/curtsy lunge.pdf" },
    { name: "Curtsy Lunge Guide (PDF)", size: "1.7MB", url: "/pdfs/ab wheel/curtsy lunge guide.pdf" },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-4/4-7"
            nextLessonPath="/courses/level1-reformers/content/chapter-4/4-8"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-4xl font-bold text-[#E43636] mb-2">Curtsy Lunge</h1>
            <p className="text-lg text-gray-600">Chapter 4 - Lesson 7</p>
          </motion.div>
          ...
          >
            <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
              <iframe
                ...
                src="https://www.youtube.com/embed/Vn1mjLYJO2A"
                title="Curtsy Lunge Tutorial"
                frameBorder="0"
          ...
          >
            <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
              <iframe
                ...
                title="Curtsy Lunge - Additional Tutorial"
                frameBorder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
              ></iframe>
          ...
          >
              ...
              >
                ...
                {activeTab === "description" && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Curtsy Lunge</h2>
