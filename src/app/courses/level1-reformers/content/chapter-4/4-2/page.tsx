...
export default function Chapter43() {
  ...
  // Tab content data
  const resources = [
    { name: "Single Leg Squat Exercise Guide (PDF)", size: "283 KB", url: "/pdfs/ab wheel/single leg squat.pdf" },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-4/4-2"
            nextLessonPath="/courses/level1-reformers/content/chapter-4/4-3"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-4xl font-bold text-[#E43636] mb-2">Single Leg Squat</h1>
            <p className="text-lg text-gray-600">Chapter 4 - Lesson 2</p>
          </motion.div>
          ...
          >
            <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
              <iframe
                ...
                title="Full Training Manual (All Reformers) - Lesson 4"
                frameBorder="0"
          ...
          >
            <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
              <iframe
                className="absolute top-0 left-0 w-full h-full"
                src="https://www.youtube.com/embed/MVvj1vOeZ9o"
                title="Additional Training Manual Tutorial"
                frameBorder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
              ></iframe>
          ...
          >
              ...
              >
                ...
                {activeTab === "description" && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Single Leg Squat</h2>
