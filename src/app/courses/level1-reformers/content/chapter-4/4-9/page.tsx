...
export default function Chapter49() {
  ...
  const resources = [
    { name: "Squatting Inner Thighs Exercise Guide (PDF)", size: "2.9 MB", url: "/pdfs/ab wheel/squatting inner thighs.pdf" },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-4/4-9"
            nextLessonPath="/courses/level1-reformers/content/chapter-4/4-10"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-4xl font-bold text-[#E43636] mb-2">Squatting Inner Thighs</h1>
            <p className="text-lg text-gray-600">Chapter 4 - Lesson 9</p>
          </motion.div>
          ...
          >
            <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
              <iframe
                ...
                src="https://www.youtube.com/embed/d0RetkE6goQ"
                title="Squatting Inner Thighs Tutorial"
                frameBorder="0"
          ...
          >
              ...
              >
                ...
                {activeTab === "description" && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Squatting Inner Thighs</h2>
