...
export default function Chapter41() {
  ...
  const images = [
    { src: "/images/Light,+Medium,+Heavy+Legs.png", alt: "Light, Medium, Heavy Legs Reference" },
  ];

  // Tab content data
  const resources = [
    { name: "Platform Lunge Exercise Guide (PDF)", size: "274 KB", url: "/pdfs/ab wheel/platform lunge.pdf" },
  ];
  ...
  const handleDoubleClick = () => {
    setZoom(prev => (prev > 1 ? 1 : Math.min(prev * 2, 3)));
    if (zoom <= 1) {
      setOffset({ x: 0, y: 0 });
    }
  };
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-4/4-1"
            nextLessonPath="/courses/level1-reformers/content/chapter-4/4-2"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-4xl font-bold text-[#E43636] mb-2">Platform Lunge</h1>
            <p className="text-lg text-gray-600">Chapter 4 - Lesson 1</p>
          </motion.div>
          ...
          >
            <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
              <iframe
                ...
                title="Light, Medium, Heavy Legs Tutorial"
                frameBorder="0"
          ...
          >
            <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
              <iframe
                ...
                title="Additional Light, Medium, Heavy Legs Tutorial"
                frameBorder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
              ></iframe>
          ...
          >
              ...
              >
                ...
                {activeTab === "description" && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Platform Lunge</h2>
                    <div className="space-y-4">
                      <p className="text-gray-700 leading-relaxed">
                        [right leg]<br />
                        In the front, facing front
                      </p>
                    </div>
                  </div>
                )}
