...
export default function Chapter105() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-reformers/content/chapter-10/10-5"
            nextLessonPath="/courses/level1-reformers/content/chapter-10/10-6"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 className="text-4xl font-bold text-[#E43636] mb-2">How to formulate leg routines (light, heavy, progression, regression)</h1>
              <p className="text-lg text-gray-600">Chapter 10 - Lesson 5</p>
            </motion.div>
            ...
            >
              <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
                <iframe
                  ...
                  src="https://www.youtube.com/embed/xR3qKn7TdvI"
                  title="Lesson 10-5"
                  frameBorder="0"
            ...
            >
              ...
              >
                {activeTab === 'description' && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">How to formulate leg routines (light, heavy, progression, regression)</h2>
                    <p className="text-gray-700 leading-relaxed">
                      Content for Lesson 10-5 will be added here.
                    </p>
                  </div>
                )}
                {activeTab === 'resources' && (
