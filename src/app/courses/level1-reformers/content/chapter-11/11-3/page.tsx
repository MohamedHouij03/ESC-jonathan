...
export default function Chapter113() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation
            currentLessonPath="/courses/level1-reformers/content/chapter-11/11-3"
            nextLessonPath="/courses/level1-reformers/content/chapter-11/11-4"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 className="text-4xl font-bold text-[#E43636] mb-2">Ab Wheel (Aka Wheelbarrow)</h1>
              <p className="text-lg text-gray-600">Chapter 11 - Lesson 3</p>
            </motion.div>
            ...
            >
              <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
                <iframe
                  ...
                  title="Ab Wheel (aka wheelbarrow)"
                  frameBorder="0"
            ...
            >
              ...
              >
                {activeTab === 'description' && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Ab Wheel (Aka Wheelbarrow)</h2>
                    <div className="space-y-4">
                      <p className="text-gray-700 leading-relaxed">
                        <strong>Xformer:</strong> 1 white spring; 2 white springs to modify
                      </p>
                      <p className="text-gray-700 leading-relaxed">
                        <strong>[Non-Xformer:</strong> 1 gray; 2 gray to modify]
                      </p>
                    </div>
                  </div>
                )}
