...
export default function Chapter1118() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation
            currentLessonPath="/courses/level1-reformers/content/chapter-11/11-18"
            nextLessonPath="/courses/level1-reformers/content/chapter-11/11-19"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 className="text-4xl font-bold text-[#E43636] mb-2">Reverse Twisted Plank to Pike</h1>
              <p className="text-lg text-gray-600">Chapter 11 - Lesson 18</p>
            </motion.div>
            ...
            >
              <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
                <iframe
                  ...
                  src="https://www.youtube.com/embed/m8RiHfh5k4c"
                  title="Reverse Twisted Plank to Pike"
                  frameBorder="0"
            ...
            >
              ...
              >
                {activeTab === 'description' && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Reverse Twisted Plank to Pike</h2>
