...
export default function Chapter117() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation
            currentLessonPath="/courses/level1-reformers/content/chapter-11/11-7"
            nextLessonPath="/courses/level1-reformers/content/chapter-11/11-8"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 className="text-4xl font-bold text-[#E43636] mb-2">Back Reverse Twister (aka French Twist)</h1>
              <p className="text-lg text-gray-600">Chapter 11 - Lesson 7</p>
            </motion.div>
            ...
            >
              ...
              >
                {activeTab === 'description' && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Back Reverse Twister (aka French Twist)</h2>
                    <div className="space-y-4">
                      <p className="text-gray-700 leading-relaxed">
                        <strong>Xformer:</strong> 1 white spring; 0 springs or perform a twister at the front
                      </p>
                      <p className="text-gray-700 leading-relaxed">
                        <strong>Non-Xformer:</strong> 1 gray spring; 0 springs or perform a twister at the front to modify
                      </p>
                    </div>
                  </div>
                )}
