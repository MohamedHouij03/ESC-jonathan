...
export default function Chapter1122() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation
            currentLessonPath="/courses/level1-reformers/content/chapter-11/11-22"
            nextLessonPath="/courses/level1-reformers/content/chapter-11/11-23"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 className="text-4xl font-bold text-[#E43636] mb-2">Lat Pushdown, Handlebar Exercises, Exercises at the back using the short hard handles, Curtsy Single Leg Step Up</h1>
              <p className="text-lg text-gray-600">Chapter 11 - Lesson 22</p>
            </motion.div>
            ...
            >
              <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
                <iframe
                  ...
                  src="https://www.youtube.com/embed/7Gbep4ntk6s"
                  title="Lat Pushdown, Handlebar Exercises, Exercises at the back using the short hard handles, Curtsy Single Leg Step Up"
                  frameBorder="0"
            ...
            >
              ...
              >
                {activeTab === 'description' && (
                  <div>
                    <h2 className="text-2xl font-bold text-[#E43636] mb-4">Lat Pushdown, Handlebar Exercises, Exercises at the back using the short hard handles, Curtsy Single Leg Step Up</h2>
