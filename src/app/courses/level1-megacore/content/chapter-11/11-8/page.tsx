...
export default function Lesson118() {
  ...
  const resources = [
    {
      title: "Advanced Spring Configuration Guide",
      description: "Comprehensive guide to advanced spring setup techniques",
      type: "PDF"
    },
    {
      title: "Equipment Maintenance Checklist",
      description: "Step-by-step maintenance procedures for optimal performance",
      type: "Checklist"
    },
    {
      title: "Spring Tension Reference Chart",
      description: "Quick reference for spring tension settings",
      type: "Chart"
    }
  ];
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="text-center">
            ...
            <p className="text-xl text-[#F6EFD2] font-semibold">
              Lesson 11-8: Advanced Spring Configuration
            </p>
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-11/11-8"
            nextLessonPath="/courses/level1-megacore/content/chapter-11/11-9"
          />
        </div>
