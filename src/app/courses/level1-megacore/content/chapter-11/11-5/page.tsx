          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-600">Chapter 11 - Lesson 5</p>
              </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-11/11-5"
            nextLessonPath="/courses/level1-megacore/content/chapter-11/11-6"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-8">
              <h1 className="text-4xl font-bold text-[#E43636] mb-4">Lesson 11-5</h1>
                ...
                {activeTab === "description" && (
                  <div>
                    ...
                    <ul className="list-disc pl-6 text-[#000000] space-y-2">
                      <li><b>Xformer:</b> 1 white spring</li>
                      <li><b>Non-Xformer:</b> 1 gray spring</li>
                    </ul>
                  </div>
                )}
