    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-white shadow-lg border-b-2 border-[#E43636]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-[#E43636] mb-2">
              Level 1 Megacore - Chapter 11
            </h1>
            <p className="text-xl text-[#000000] font-semibold">
              Lesson 11-7: Spring Configuration
            </p>
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-11/11-7"
            nextLessonPath="/courses/level1-megacore/content/chapter-11/11-8"
          />
        </div>
          ...
          >
            ...
            <div className="w-full flex justify-center">
              <iframe
                ...
                allowFullScreen
                className="rounded-xl w-full max-w-4xl h-80"
              ></iframe>
            </div>
          </motion.div>
