...
export default function Lesson63() {
  ...
  const lessonGoals = [
    'Master Skater & Shifted Skater (left leg) form and technique',
    'Understand proper hip and knee alignment',
    'Learn safe and effective skater exercise execution',
    'Practice holds and pulses for progression'
  ];

  const resources = [
    { name: 'Skater & Shifted Skater Guide PDF', type: 'pdf', size: '2.1 MB' },
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-6/6-3"
          />
          {/* Main Content Area */}
          <div className="flex-1">
            ...
            >
              <div className="bg-black rounded-2xl overflow-hidden shadow-2xl">
                <iframe
                  width="100%"
                  height="500"
                  src="https://www.youtube.com/embed/8aYvcjlRzpM"
                  title="Skater & Shifted Skater (Left Leg) Tutorial"
                  frameBorder="0"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-[#E43636]">
              ...
              {activeTab === 'description' && (
                <div>
                  <h2 className="text-3xl font-bold text-[#E43636] mb-6">Skater (Left Leg)</h2>
                  {/* Lesson Goals */}
                  ...
                  {/* Skater Exercise Details */}
                  <div className="space-y-8">
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Skater (Left Leg)</h3>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        ...
                        <li>Push through both your feet hip width apart to open the carriage</li>
                        <li>Sit down and back into a squat position</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Execution</h3>
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li><b>Exhale:</b> Your right foot pushes the carriage out (keeping your hips and the left side of your body still).</li>
                        <li><b>Inhale:</b> Your right knee bends to slowly bring the carriage back in, stopping just before you lose tension.</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">DO NOT</h3>
                      <ul className="list-disc pl-6 text-[#E43636] space-y-2">
                        <li>DO NOT push the carriage out and in quickly.</li>
                        <li>DO NOT move your hips and left side of your body as you perform the exercise.</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Modifications</h3>
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li>Shorten the range of motion. You do not need to push all the way out. Less is more.</li>
                  ...
                  {/* Shifted Skater */}
                  <h2 className="text-3xl font-bold text-[#E43636] mt-12 mb-6">Shifted Skater (Left Leg)</h2>
                  <div className="space-y-8">
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Shifted Skater (Left Leg)</h3>
                      <p className="text-[#000000] mb-4">In the front, facing sideways</p>
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        <div className="bg-white p-4 rounded-xl border border-[#E43636]">
                          <p className="text-sm text-[#E43636] font-semibold">Standard</p>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        ...
                        <li>Push through both your feet hip width apart to open the carriage</li>
                        <li>Sit down and back into a squat position</li>
                        <li>Shift your weight towards the front platform and keep the weight that direction throughout the exercise.</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Execution</h3>
                    ...
                    <section>
                      ...
                      <div className="bg-white p-6 rounded-xl border border-[#E43636]">
                        ...
                        <p className="text-[#000000]">Pulse in 2 inches and out 2 inches (easier)</p>
                        <p className="text-[#000000]">Pulse out 2 inches and in 2 inches (harder)</p>
                        <p className="text-[#E43636] mt-2">Note: this exercise has a shorter range of motion of the pushing leg in comparison to “Skater”</p>
                      </div>
                    </section>
                  </div>
                </div>
