...
export default function Lesson611() {
  const [activeTab, setActiveTab] = useState('description');
  const { progress } = useUserProgress('level1-megacore');
  const [isClient, setIsClient] = useState(false);

  const lessonGoals = [
    'Master Donkey Kick (left leg) form and technique',
    'Understand proper hip and knee alignment',
    'Learn safe and effective Donkey Kick execution',
    'Practice holds and pulses for progression'
  ];

  const resources = [
    { name: 'Donkey Kick Guide PDF', type: 'pdf', size: '2.1 MB' },
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-6/6-11"
          />
          {/* Main Content Area */}
          <div className="flex-1">
            ...
            >
              <div className="bg-black rounded-2xl overflow-hidden shadow-2xl">
                <iframe
                  width="100%"
                  height="500"
                  src="https://www.youtube.com/embed/jjsklpaEOTw"
                  title="Donkey Kick (Left Leg) Tutorial"
                  frameBorder="0"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-[#E43636]">
              ...
              {activeTab === 'description' && (
                <div>
                  <h2 className="text-3xl font-bold text-[#E43636] mb-6">Donkey Kick (Left Leg)</h2>
                  {/* Lesson Goals */}
                  ...
                  <div className="space-y-8">
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Donkey Kick (Left Leg)</h3>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li>Kneel on the carriage facing the back platform, turn around to your left and turn the handlebar outwards away from the reformer</li>
                        <li>Scoot back towards the edge of the carriage and set your hands and knees down on the carriage wide apart</li>
                        <li>Place your left heel against the curvature of black handlebar behind you, with your toes facing slightly down and out at a 45 degree angle</li>
                        <li>DO NOT have the feet sideways with the handlebar</li>
                      </ul>
                    </section>
                    <section>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        ...
                        <li>Use less springs (if the client cannot go slow or you notice more upper body involvement, the spring load may be too heavy)</li>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li>Hover the right knee above the carriage instead of keeping it on the carriage to perform a "Flying Donkey Kick"</li>
                      </ul>
                    </section>
                    <section>
