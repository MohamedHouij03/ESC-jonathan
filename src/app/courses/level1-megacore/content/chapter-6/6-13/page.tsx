...
export default function Lesson613() {
  const [activeTab, setActiveTab] = useState('description');
  const { progress } = useUserProgress('level1-megacore');
  const [isClient, setIsClient] = useState(false);

  const lessonGoals = [
    'Master Heavy Single Leg Press (in bridge position) form and technique',
    'Understand proper bridge position and hip alignment',
    'Learn safe and effective single leg press execution',
    'Practice holds and pulses for progression'
  ];

  const resources = [
    { name: 'Heavy Single Leg Press Guide PDF', type: 'pdf', size: '2.1 MB' },
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-6/6-13"
          />
          {/* Main Content Area */}
          <div className="flex-1">
            ...
            >
              <div className="bg-black rounded-2xl overflow-hidden shadow-2xl">
                <iframe
                  ...
                  title="Heavy Single Leg Press (Bridge Position) Tutorial"
                  frameBorder="0"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-[#E43636]">
              ...
              {activeTab === 'description' && (
                <div>
                  <h2 className="text-3xl font-bold text-[#E43636] mb-6">Heavy Single Leg Press (Bridge Position)</h2>
                  {/* Lesson Goals */}
                  ...
                  <div className="space-y-8">
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Heavy Single Leg Press (Bridge Position)</h3>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        ...
                        <li>Turn the handlebars inwards to face each other</li>
                        <li>Scoot all the way forward to the end of the carriage and lay down with your head towards the back platform</li>
                        <li>Hold onto the front carriage straps with your hands and bring both your heels onto the handlebars</li>
                        <li>Lift up into a bridge position and then lift up the left leg towards the sky</li>
                        <li>You can cross your left leg over your right thigh like how a guy crosses his legs if the straight leg up is uncomfortable</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Execution</h3>
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li><b>Exhale:</b> As you push your right heel into the handlebar to move the carriage back</li>
                        <li><b>Inhale:</b> As you bend your right knee to bring the carriage back</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">DO NOT</h3>
                      <ul className="list-disc pl-6 text-[#E43636] space-y-2">
                        <li>DO NOT go so far back that you drop your hips or arch your back</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Modifications</h3>
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li>Both feet down onto the handlebars instead of one</li>
                        <li>For back and hip pain, lower the back down to the carriage until you can come back up into a glute bridge position</li>
                      </ul>
                    </section>
                    <section>
