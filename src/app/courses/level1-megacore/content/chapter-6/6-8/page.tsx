...
export default function Lesson68() {
  ...
  const lessonGoals = [
    'Master Black Widow (left leg) form and technique',
    'Understand proper hip and knee alignment',
    'Learn safe and effective Black Widow execution',
    'Practice holds and pulses for progression'
  ];

  const resources = [
    { name: 'Black Widow Guide PDF', type: 'pdf', size: '2.1 MB' },
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-6/6-8"
          />
          {/* Main Content Area */}
          <div className="flex-1">
            ...
            >
              <div className="bg-black rounded-2xl overflow-hidden shadow-2xl">
                <iframe
                  width="100%"
                  height="500"
                  src="https://www.youtube.com/embed/9dhA3_-X7vI"
                  title="Black Widow (Left Leg) Tutorial"
                  frameBorder="0"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-[#E43636]">
              ...
              {activeTab === 'description' && (
                <div>
                  <h2 className="text-3xl font-bold text-[#E43636] mb-6">Black Widow (Left Leg)</h2>
                  {/* Lesson Goals */}
                  ...
                  <div className="space-y-8">
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Black Widow (Left Leg)</h3>
                      <p className="text-[#000000] mb-4">On the carriage, facing the sideways</p>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        ...
                        <li>Lift up the right black handlebar and turn it outwards to the right</li>
                        <li>Turning to face the direction you turned the black handlebar out, kneel on the carriage with your hands and knees wide apart near the front edge of the carriage</li>
                        <li>Place your left heel or arch of foot onto the turned out black handlebar with your toes facing diagonally up</li>
                        <li>Your left hand holds onto the front carriage strap and the right hand will be directly underneath your right shoulder on the carriage</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Execution</h3>
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li><b>Exhale:</b> The left foot pushes into the black handlebar to push the carriage out, while keeping the right knee under the right hip the entire time</li>
                        <li><b>Inhale:</b> Bend the left knee to bring the carriage in</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">DO NOT</h3>
                      <ul className="list-disc pl-6 text-[#E43636] space-y-2">
                        <li>DO NOT push out or come in too quickly</li>
                        <li>DO NOT use your anchored knee to push the carriage outwards</li>
                        <li>DO NOT shift the hips or allow the anchored knee on the carriage to sway in or out while pushing out and in</li>
                      </ul>
                    </section>
                    <section>
                    ...
                    <section>
                      ...
                      <div className="bg-white p-6 rounded-xl border border-[#E43636]">
                        ...
                        <p className="text-[#E43636] mt-2">Note: I rarely teach this because most people complain of the awkward position of their hips</p>
                      </div>
                    </section>
                  </div>
                </div>
