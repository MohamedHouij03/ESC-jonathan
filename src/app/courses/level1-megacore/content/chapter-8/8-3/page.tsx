...
export default function Lesson83() {
  ...
  const lessonGoals = [
    'Master Chest Expansion form and technique',
    'Understand proper arm positioning and palm placement',
    'Learn safe and effective chest and shoulder activation',
    'Practice maintaining proper posture throughout the movement'
  ];

  const resources = [
    { name: 'Chest Expansion Exercise Guide PDF', type: 'pdf', size: '2.2 MB' },
    { name: 'Upper Body Posture Training', type: 'pdf', size: '1.9 MB' },
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-8/8-3"
          />
          {/* Main Content Area */}
          <div className="flex-1">
            ...
            >
              <div className="bg-black rounded-2xl overflow-hidden shadow-2xl">
                <iframe
                  ...
                  title="Chest Expansion Exercise Tutorial"
                  frameBorder="0"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-[#E43636]">
              ...
              {activeTab === 'description' && (
                <div>
                  <h2 className="text-3xl font-bold text-[#E43636] mb-6">Chest Expansion</h2>
                  {/* Lesson Goals */}
                  ...
                  <div className="space-y-8">
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Chest Expansion</h3>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        ...
                        <li>Bring your arms and hands by your sides, palms facing back</li>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li><b>Exhale:</b> As you press through your palms to bring your hands back as far as you can</li>
                        <li><b>Inhale:</b> As you bring your hands forward, stopping by your sides</li>
                        <li><b>Note:</b> You can allow the hands to pass the hips if your intention is more range of motion</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">DO NOT</h3>
                      <ul className="list-disc pl-6 text-[#E43636] space-y-2">
                        <li>DO NOT use your trapezius (traps) (neck muscles between your shoulders)</li>
                    ...
                    <section>
                      ...
                      <div className="bg-white p-6 rounded-xl border border-[#E43636]">
                        ...
                        <ul className="list-disc pl-6 text-[#000000] space-y-2">
                          <li>Bring your arms and hands back halfway</li>
                          <li>pulse forward 2 inches and back 2 inches (easier)</li>
                          <li>pulse back 2 inches and forward 2 inches (harder)</li>
                        </ul>
                      </div>
                    </section>
                  </div>
