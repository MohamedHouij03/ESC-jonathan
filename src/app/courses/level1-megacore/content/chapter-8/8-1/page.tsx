...
export default function Lesson81() {
  ...
  const resources = [
    { name: 'Bicep Curl Exercise Guide PDF', type: 'pdf', size: '2.2 MB' },
    { name: 'Upper Body Strength Training', type: 'pdf', size: '1.9 MB' },
    { name: 'Spring Load Reference', type: 'pdf', size: '0.8 MB' },
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-8/8-1"
          />
          {/* Main Content Area */}
          <div className="flex-1">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-[#E43636]">
              ...
              {activeTab === 'description' && (
                <div>
                  <h2 className="text-3xl font-bold text-[#E43636] mb-6">Bicep Curl</h2>
                  ...
                  <div className="space-y-8">
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Exercise Details</h3>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        ...
                        <div className="bg-white p-4 rounded-xl border border-[#E43636]">
                          ...
                          <p className="text-lg font-bold text-[#000000]">1 black + 1 gray</p>
                        </div>
                      </div>
                    </section>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        ...
                        <li>Bring your arms and hands up shoulder height high</li>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li><b>Exhale:</b> As you bend your elbows to bring your hands to your face</li>
                        <li><b>Inhale:</b> As you lengthen your arms forward, but not too far that you lose tension</li>
                      </ul>
                    </section>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#E43636] space-y-2">
                        ...
                        <li>Lower the elbows to take it out of your trapezius</li>
                    ...
                    <section>
                      ...
                      <div className="bg-white p-6 rounded-xl border border-[#E43636]">
                        <ul className="list-disc pl-6 text-[#000000] space-y-2">
                          <li>Move back on the carriage towards the front platform</li>
                          <li>Cross your cables like an "X" and re-hold the cables once crossed</li>
                        </ul>
                      </div>
                    </section>
                    ...
                    <section>
                      ...
                      <div className="bg-white p-6 rounded-xl border border-[#E43636]">
                        ...
                        <ul className="list-disc pl-6 text-[#000000] space-y-2">
                          <li>Bring your hands in halfway</li>
                          <li>pulse out 2 inches and in 2 inches (easier)</li>
                          <li>pulse in 2 inches and out 2 inches (harder)</li>
                        </ul>
                      </div>
                    </section>
                  </div>
