...
export default function Lesson414() {
  ...
  const lessonGoals = [
    'Master Standing Inner Thighs (right leg) form and technique',
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-4/4-14"
            nextLessonPath="/courses/level1-megacore/content/chapter-5/5-1"
          />
          {/* Main Content Area */}
          <div className="flex-1">
            ...
            >
              <div className="bg-black rounded-2xl overflow-hidden shadow-2xl">
                <iframe
                  ...
                  title="Standing Inner Thighs (Right Leg) Tutorial"
                  frameBorder="0"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-[#E43636]">
              ...
              {activeTab === 'description' && (
                <div>
                  <h2 className="text-3xl font-bold text-[#E43636] mb-6">Standing Inner Thighs (Right Leg)</h2>
                  {/* Lesson Goals */}
                  ...
                  <div className="space-y-8">
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Standing Inner Thighs (Right Leg)</h3>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        ...
                        <div className="bg-white p-4 rounded-xl border border-[#E43636]">
                          ...
                          <p className="text-lg font-bold text-[#000000]">Go slower or move the foot on the carriage closer to the middle</p>
                        </div>
                      </div>
                    </section>
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li>Start by standing on the front platform facing forward and then turn to the left</li>
                        <li>Place your right foot under the front platform strap and the left foot under the front carriage strap</li>
                        <li>Slightly bend your knees and make sure toes are facing forward</li>
                        <li>Separate your feet wide as or wider than your hips to start</li>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li><b>Inhale:</b> Start to evenly separate the feet and legs apart, distributing your weight into both legs equally</li>
                        <li><b>Exhale:</b> Press your heels down while squeezing both inner thighs equally to pull the carriage back in until your feet are under your shoulders</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">DO NOT</h3>
                      <ul className="list-disc pl-6 text-[#E43636] space-y-2">
                        <li>DO NOT Squeeze the inner knees to bring the carriage in</li>
                        <li>DO NOT Go so far that you have trouble coming back in</li>
                        <li>DO NOT Put more weight into the leg on the front platform</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Modifications</h3>
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li>Bring the foot on the carriage closer to the edge</li>
                        <li>Use the stabilization bar</li>
                        <li>Two white springs</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Variations</h3>
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li>Midway Holds / Pulses</li>
                        <li>Full Range Holds / Pulses</li>
                        <li>Squat pulses</li>
                        <li>Squatting inner thighs</li>
                        <li>Squat hold with Skater</li>
                        <li>Squat hold with Heel Raises (at the same time or alternate)</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Challenge</h3>
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li>Go slower or move the foot on the carriage closer to the middle</li>
                      </ul>
                    </section>
                  </div>
                </div>
