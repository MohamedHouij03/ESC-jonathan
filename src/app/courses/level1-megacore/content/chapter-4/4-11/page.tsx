...
export default function Lesson411() {
  ...
  const lessonGoals = [
    'Master Curtsy Lunge (left leg) form and technique',
    'Understand hip, knee, and foot alignment',
    'Learn safe and effective lunge execution',
    'Practice holds and pulses for progression'
  ];

  const resources = [
    { name: 'Curtsy Lunge Guide PDF', type: 'pdf', size: '2.2 MB' },
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-4/4-11"
            nextLessonPath="/courses/level1-megacore/content/chapter-4/4-12"
          />
          {/* Main Content Area */}
          <div className="flex-1">
            ...
            >
              <div className="bg-black rounded-2xl overflow-hidden shadow-2xl">
                <iframe
                  width="100%"
                  height="500"
                  src="https://www.youtube.com/embed/LIYhTFTYLPo"
                  title="Curtsy Lunge (Left Leg) Tutorial"
                  frameBorder="0"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-[#E43636]">
              ...
              {activeTab === 'description' && (
                <div>
                  <h2 className="text-3xl font-bold text-[#E43636] mb-6">Curtsy Lunge (Left Leg)</h2>
                  {/* Lesson Goals */}
                  ...
                  <div className="space-y-8">
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Curtsy Lunge (Left Leg)</h3>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li>Start by standing on the front platform, facing forward</li>
                        <li>Walk your feet all the way over to the right and place your fingers on the handle bars for safety</li>
                        <li>Lift your right foot & hook it back & behind you to the left (the further the leg is hooked, the more difficult the exercise)</li>
                        <li>Lower down into a lunge position and hold</li>
                        <li><b>Notes:</b> If you cannot keep your hips squared, you can untwist to the right by 1 hour</li>
                        <li>If there is tightness in your hips, try turning your left foot outwards to the left to open the hips more</li>
                        <li>If this is too difficult or doesn't feel good for the knees or hips, perform a platform lunge instead</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Execution</h3>
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li><b>Exhale:</b> Push through your left foot into the platform to rise</li>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#E43636] space-y-2">
                        <li>DO NOT come up pressing more weight into the outer part of your foot</li>
                        <li>DO NOT allow your left knee to collapse outwards away from the midline. This will put a lot of pressure on your knees</li>
                        <li>DO NOT let the knee pass the toes when lunging</li>
                        <li>DO NOT stay hunched over the whole exercise with hands on the bars. Use the stabilization pole or add a 2nd or 3rd gray spring to modify</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Modifications</h3>
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li>Perform a "Platform Lunge" instead; or 2 to 3 gray springs</li>
                      </ul>
                    </section>
                    <section>
                    ...
                    <section>
                      ...
                      <div className="bg-white p-6 rounded-xl border border-[#E43636]">
                        ...
                        <p className="text-[#000000]">Pulse 2 inches up and 2 inches down (easier)</p>
                        <p className="text-[#000000]">Pulse 2 inches down and 2 inches up (harder)</p>
                      </div>
                    </section>
                  </div>
                </div>
