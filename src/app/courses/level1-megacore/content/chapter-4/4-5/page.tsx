...
export default function Lesson45() {
  ...
  const chapterLessons = [
    ...
    { id: 3, title: 'Single Leg Squat', duration: '14 min', completed: true },
    { id: 4, title: 'Chapter 4 - Lesson 4', duration: '10 min', completed: true },
    { id: 5, title: 'Carriage Lunge', duration: '13 min', completed: true },
  ...
  const lessonGoals = [
    'Master Carriage Lunge (right leg) form and technique',
  ...
  const resources = [
    { name: 'Carriage Lunge Guide PDF', type: 'pdf', size: '2.1 MB' },
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-4/4-5"
            nextLessonPath="/courses/level1-megacore/content/chapter-4/4-6"
          />
          {/* Main Content Area */}
          <div className="flex-1">
            ...
            >
              <div className="bg-black rounded-2xl overflow-hidden shadow-2xl">
                <iframe
                  width="100%"
                  height="500"
                  src="https://www.youtube.com/embed/Jha9X0NZtAk"
                  title="Carriage Lunge (Right Leg) Tutorial"
                  frameBorder="0"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-[#E43636]">
              ...
              {activeTab === 'description' && (
                <div>
                  <h2 className="text-3xl font-bold text-[#E43636] mb-6">Carriage Lunge (Right Leg)</h2>
                  {/* Lesson Goals */}
                  ...
                  <div className="space-y-8">
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Carriage Lunge (Right Leg)</h3>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li>Start by standing on the front platform, facing the carriage</li>
                        <li>Right foot under the front carriage strap, left foot stays behind on the front platform, toes down, heels up</li>
                        <li>Left leg should be straight with a slight bend in your knee</li>
                        <li><b>Note:</b> If using the stabilization pole: grab the pole with your left hand and move it forward to the middle of the carriage on the left side</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Execution</h3>
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li><b>Inhale:</b> Lower down and forward hinging from the hips lowering the chest</li>
                        <li><b>Exhale:</b> Constantly press down through your right heel into the carriage lifting the chest as you come up</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">DO NOT</h3>
                      <ul className="list-disc pl-6 text-[#E43636] space-y-2">
                        <li>DO NOT let the knee pass the toes when lunging downward</li>
                        <li>DO NOT let the knee collapse inward towards the belly button</li>
                        <li>DO NOT press down the toes of the foot on the front platform (this will activate the wrong leg)</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Modifications</h3>
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li>Use the stabilization pole</li>
                        <li>2 gray springs; or 3 gray springs as the max to modify</li>
                      </ul>
                    </section>
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li>Go slower</li>
                        <li>Move the foot on the carriage towards the center</li>
                    ...
                    <section>
                      ...
                      <div className="bg-white p-6 rounded-xl border border-[#E43636]">
                        ...
                        <p className="text-[#000000]">Meet down halfway</p>
                        <p className="text-[#000000]">Pulse up and in 2 inches and down and out 2 inches (easier)</p>
                        <p className="text-[#000000]">Pulse down and out 2 inches and up and in 2 inches (harder)</p>
                      </div>
                    </section>
                  </div>
                </div>
