...
export default function Lesson413() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-4/4-13"
            nextLessonPath="/courses/level1-megacore/content/chapter-4/4-14"
          />
          {/* Main Content Area */}
