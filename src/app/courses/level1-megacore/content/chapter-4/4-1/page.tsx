...
export default function Lesson41() {
  ...
  // removed Chapter Lessons list

  const lessonGoals = [
    'Master Platform Lunge (right leg) form and technique',
  ...
  const resources = [
    { name: 'Platform Lunge Guide PDF', type: 'pdf', size: '2.1 MB' },
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="flex min-h-screen">
        ...
        <CourseNavigation 
          currentLessonPath="/courses/level1-megacore/content/chapter-4/4-1"
          nextLessonPath="/courses/level1-megacore/content/chapter-4/4-2"
        />
        
        {/* Main Content Area */}
        <div className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-8 pt-20 lg:pt-8">
          <div className="w-full">
            ...
            >
              <div className="bg-black rounded-2xl overflow-hidden shadow-2xl">
                <iframe
                  width="100%"
                  height="500"
                  src="https://www.youtube.com/embed/X7FZkXiHjJY"
                  title="Platform Lunge (Right Leg) Tutorial"
                  frameBorder="0"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-[#E43636]">
              ...
              {activeTab === 'description' && (
                <div>
                  <h2 className="text-3xl font-bold text-[#E43636] mb-6">Platform Lunge (Right Leg)</h2>
                  {/* Lesson Goals */}
                  ...
                  <div className="space-y-8">
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Platform Lunge (Right Leg)</h3>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        ...
                        <li>Your right foot stays on the front platform and your left toes go onto the edge of the carriage behind you</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Execution</h3>
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li><b>Inhale:</b> Lower down hinging from the hips</li>
                        <li><b>Exhale:</b> Press through your right foot into the front platform lifting the chest as you come up</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">DO NOT</h3>
                      <ul className="list-disc pl-6 text-[#E43636] space-y-2">
                        <li>DO NOT allow your knee to collapse inwards towards your midline or belly button</li>
                        <li>DO NOT let your knee move forward as you come up and back as you come down</li>
                      </ul>
                    </section>
                    <section>
