                  ...
                  <div className="space-y-8">
                    ...
                    <section>
                      <div className="bg-gradient-to-r from-[#E43636] to-[#b82a2a] rounded-xl p-8 text-center text-white">
                        <h3 className="text-2xl font-bold mb-4">🎉 Chapter 4 Complete Mastery Achievement! 🎉</h3>
                        ...
                        <ul className="text-left max-w-md mx-auto space-y-2">
                          <li>• Platform Lunge techniques</li>
                          <li>• Single Leg Squat mastery</li>
                          <li>• Carriage Lunge variations</li>
                          <li>• Floor Lunge execution</li>
                          <li>• Side Lunge proficiency</li>
                          <li>• Light Squat techniques</li>
                          <li>• Curtsy Lunge mastery (both legs)</li>
                          <li>• Standing Inner Thighs expertise</li>
                        </ul>
