...
export default function Lesson410() {
  ...
  const lessonGoals = [
    'Master Curtsy Lunge (right leg) form and technique',
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-4/4-10"
            nextLessonPath="/courses/level1-megacore/content/chapter-4/4-11"
          />
          {/* Main Content Area */}
          <div className="flex-1">
            ...
            >
              <div className="bg-black rounded-2xl overflow-hidden shadow-2xl">
                <iframe
                  ...
                  title="Curtsy Lunge (Right Leg) Tutorial"
                  frameBorder="0"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-[#E43636]">
              ...
              {activeTab === 'description' && (
                <div>
                  <h2 className="text-3xl font-bold text-[#E43636] mb-6">Curtsy Lunge (Right Leg)</h2>
                  {/* Lesson Goals */}
                  ...
                  <div className="space-y-8">
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Curtsy Lunge (Right Leg)</h3>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        ...
                        <li>Walk your feet all the way over to the left and place your fingers on the handle bars for safety</li>
                        <li>Lift your left foot & hook it back & behind you to the right (the further the leg is hooked, the more difficult the exercise)</li>
                        <li>Lower down into a lunge position and hold</li>
                        <li><b>Notes:</b> If you cannot keep your hips squared, you can untwist to the left by 1 hour</li>
                        <li>If there is tightness in your hips, try turning your right foot outwards to the right to open the hips more</li>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li><b>Exhale:</b> Push through your right foot into the platform to rise</li>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#E43636] space-y-2">
                        ...
                        <li>DO NOT allow your right knee to collapse outwards away from the midline. This will put a lot of pressure on your knees</li>
