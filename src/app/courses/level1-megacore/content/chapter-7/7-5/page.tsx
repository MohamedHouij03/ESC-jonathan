...
export default function Lesson75() {
  ...
  const lessonGoals = [
    'Master Oblique Glute Kickback form and technique',
    'Understand proper kneeling position and strap placement',
    'Learn safe and effective glute and oblique activation',
    'Practice maintaining hip stability during kickback movements'
  ];

  const resources = [
    { name: 'Oblique Glute Kickback Guide PDF', type: 'pdf', size: '2.3 MB' },
    { name: 'Glute Activation Techniques', type: 'pdf', size: '1.9 MB' },
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-7/7-5"
          />
          {/* Main Content Area */}
          <div className="flex-1">
            ...
            >
              <div className="bg-black rounded-2xl overflow-hidden shadow-2xl">
                <iframe
                  width="100%"
                  height="500"
                  src="https://www.youtube.com/embed/ol-0eiBYUCI"
                  title="Oblique Glute Kickback Tutorial"
                  frameBorder="0"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-[#E43636]">
              ...
              {activeTab === 'description' && (
                <div>
                  <h2 className="text-3xl font-bold text-[#E43636] mb-6">Oblique Glute Kickback (Right Oblique)</h2>
                  {/* Lesson Goals */}
                  ...
                  <div className="space-y-8">
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Oblique Glute Kickback (Right Oblique)</h3>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        ...
                        <li>With your right hand, pick up the long black strap and pull it inward</li>
                        <li>Use your left hand to grab the rope and pull in from the rope to lessen slack out of the long strap</li>
                        <li>Place the long black strap through your right foot and set the knee down onto the carriage</li>
                        <li>Hands and knees wide apart</li>
                        <li>Left hand holds the left side of the carriage and then lift your right knee a few inches above the carriage and turn the foot out slightly to point down and out to a 45 degree angle</li>
                        <li>Maintain a soft bend in your left elbow and engage your core</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Execution</h3>
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li>(holding onto the left side of the carriage with your left hand to stay towards the right side)</li>
                        <li><b>Exhale:</b> As you kick back, pushing your feet against the strap to lengthen your right leg</li>
                        <li><b>Inhale:</b> As you slowly bend your right knee forward until your knee is to the right side of your hip</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">DO NOT</h3>
                      <ul className="list-disc pl-6 text-[#E43636] space-y-2">
                        <li>DO NOT let your left hip lean outwards to the left as you bend and lengthen the target leg</li>
                        <li>DO NOT lock out your elbow</li>
                      </ul>
                    </section>
                    <section>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li>Go slower or add 1 gray spring to your black spring</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Challenges</h3>
                      <div className="bg-white p-6 rounded-xl border border-[#E43636]">
                        <p className="text-[#000000] font-semibold mb-2">Leg Circles:</p>
                        <p className="text-[#000000]">Extend the right leg out and point your toes</p>
                        <p className="text-[#000000]">Draw a continuous circle with your toes clockwise</p>
                      </div>
                    </section>
                    <section>
                      <div className="bg-white p-6 rounded-xl border border-[#E43636]">
                        <p className="text-[#E43636]"><b>Note:</b> This exercise is an alternative to "Oblique Sweep"</p>
                      </div>
                    </section>
                  </div>
                </div>
