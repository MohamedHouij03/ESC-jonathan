...
export default function Lesson72() {
  ...
  const lessonGoals = [
    'Master advanced torso twist techniques',
  ...
  const resources = [
    { name: 'Advanced Torso Twist Guide PDF', type: 'pdf', size: '2.2 MB' },
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-7/7-2"
          />
          {/* Main Content Area */}
          <div className="flex-1">
            ...
            >
              <div className="bg-black rounded-2xl overflow-hidden shadow-2xl">
                <iframe
                  ...
                  title="Advanced Torso Twist Tutorial"
                  frameBorder="0"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-[#E43636]">
              ...
              {activeTab === 'description' && (
                <div>
                  <h2 className="text-3xl font-bold text-[#E43636] mb-6">Lesson 7-2: Advanced Torso Twist</h2>
                  {/* Lesson Goals */}
                  ...
                  <div className="space-y-8">
                    <section>
                      ...
                      <p className="text-[#000000] mb-4">This lesson covers advanced torso twist techniques to build core strength and improve rotational power.</p>
