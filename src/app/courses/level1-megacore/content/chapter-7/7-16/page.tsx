...
export default function Lesson716() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-7/7-16"
            nextLessonPath="/courses/level1-megacore/content/chapter-7/7-17"
          />
          {/* Main Content Area */}
          <div className="flex-1">
            ...
            >
              <div className="bg-black rounded-2xl overflow-hidden shadow-2xl">
                <iframe
                  width="100%"
                  height="500"
                  src="https://www.youtube.com/embed/4od8gvrD5gc"
                  title="Mermaid Crunch Exercise Tutorial"
                  frameBorder="0"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-[#E43636]">
              ...
              {activeTab === 'description' && (
                <div>
                  <h2 className="text-3xl font-bold text-[#E43636] mb-6">Mermaid Crunch Exercise</h2>
                  
                  {/* Mermaid Crunch */}
                  <div className="bg-white rounded-xl p-6 mb-8 border border-[#E43636]">
                    <h3 className="text-2xl font-bold text-[#E43636] mb-4">Mermaid Crunch [left oblique]</h3>
                    <div className="mb-4">
                      <h4 className="text-lg font-semibold text-[#E43636] mb-2">Position & Springs</h4>
                      <ul className="list-disc pl-6 text-[#000000] space-y-1">
                        <li>Seated on the back platform, facing sideways</li>
                        <li><b>Springs:</b> no springs are required for this exercise</li>
                      </ul>
                    </div>
                    <div className="mb-4">
                      <h4 className="text-lg font-semibold text-[#E43636] mb-2">Setup</h4>
                      <ul className="list-disc pl-6 text-[#000000] space-y-1">
                        <li>Sit at the back platform facing the front platform</li>
                        <li>Turn to your right, sit on your right hip, and set your right leg up onto the back platform, bending it at a 90-degree angle (do not tuck the right leg under your left thigh)</li>
                        <li>Tuck your left foot under the adjustable floor strap in the well</li>
                        <li>Left hand to the side of your head and right hand behind your back</li>
                        <li>Lower down to the right as low as you can hold</li>
                      </ul>
                    </div>
                    <div className="mb-4">
                      <h4 className="text-lg font-semibold text-[#E43636] mb-2">Execution</h4>
                      <ul className="list-disc pl-6 text-[#000000] space-y-1">
                        <li><b>Exhale:</b> As you press your right hip down and into the back platform to lift and fold your body up and to the left (guiding your left elbow to your left outer thigh).</li>
                        <li><b>Inhale:</b> As you lower down to the right to the starting position.</li>
                      </ul>
                    </div>
                    <div className="mb-4">
                      <h4 className="text-lg font-semibold text-red-600 mb-2">DO NOT</h4>
                      <ul className="list-disc pl-6 text-[#E43636] space-y-1">
                        <li>DO NOT let your shoulders hunch and round forward.</li>
                        <li>DO NOT hook your foot under the floor strap so much that you're activating the right outer leg instead of your right oblique.</li>
                        <li>DO NOT swing upwards</li>
                      </ul>
                    </div>
                    <div className="mb-4">
                    ...
                    <div className="mb-4">
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-1">
                        ...
                        <li>Meet me as low as you can go</li>
                        <li>Pulse up 2 inches and down 2 inches (squeezing or folding from the right oblique)</li>
                      </ul>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-white p-4 rounded-xl border border-[#E43636] hover:bg-[#E43636] hover:text-[#F6EFD2] transition-colors cursor-pointer">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="font-semibold text-black">Mermaid Crunch Guide PDF</p>
