...
export default function Lesson74() {
  ...
  const lessonGoals = [
    'Master Oblique Kickback form and technique',
  ...
  const resources = [
    { name: 'Oblique Kickback Guide PDF', type: 'pdf', size: '2.2 MB' },
    { name: 'Advanced Hip Stability Training', type: 'pdf', size: '1.8 MB' },
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-7/7-4"
          />
          {/* Main Content Area */}
          <div className="flex-1">
            ...
            >
              <div className="bg-black rounded-2xl overflow-hidden shadow-2xl">
                <iframe
                  width="100%"
                  height="500"
                  src="https://www.youtube.com/embed/f0oT1mzBljE"
                  title="Oblique Kickback Tutorial"
                  frameBorder="0"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-[#E43636]">
              ...
              {activeTab === 'description' && (
                <div>
                  <h2 className="text-3xl font-bold text-[#E43636] mb-6">Oblique Kickback (Right Oblique)</h2>
                  {/* Lesson Goals */}
                  ...
                  <div className="space-y-8">
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Oblique Kickback (Right Oblique)</h3>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        ...
                        <li>Left forearm down and against the back carriage strap with your right hand holding the right side of the carriage</li>
                        <li>Look over your right shoulder, kick your leg up and back, and bring the left hip in (in line with your left knee)</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Execution</h3>
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li>(use your left forearm against the carriage strap and your right hand holding onto the right side of the carriage to keep the left hip above the left knee)</li>
                        <li><b>Inhale:</b> As you slowly bend your right knee towards your chest, stopping when your knee is to the right side of your hip</li>
                        <li><b>Exhale:</b> As you kick up and back, pushing your feet against the strap to lengthen your right leg</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">DO NOT</h3>
                      <ul className="list-disc pl-6 text-[#E43636] space-y-2">
                        <li>DO NOT let your left hip lean outwards to the left as you perform the exercise</li>
                      </ul>
                    </section>
                    <section>
                    ...
                    <section>
                      <div className="bg-white p-6 rounded-xl border border-[#E43636]">
                        <p className="text-[#E43636]"><b>Note:</b> This exercise is extremely difficult, so do not teach it to beginners</p>
                      </div>
                    </section>
                  </div>
                </div>
