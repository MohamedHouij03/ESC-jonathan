...
export default function Lesson710() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-7/7-10"
            nextLessonPath="/courses/level1-megacore/content/chapter-7/7-11"
          />
          {/* Main Content Area */}
          <div className="flex-1">
            ...
            >
              <div className="bg-black rounded-2xl overflow-hidden shadow-2xl">
                <iframe
                  width="100%"
                  height="500"
                  src="https://www.youtube.com/embed/3Gttm_3_z9Q"
                  title="Side Plank Exercises Tutorial"
                  frameBorder="0"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-[#E43636]">
              ...
              {activeTab === 'description' && (
                <div>
                  <h2 className="text-3xl font-bold text-[#E43636] mb-6">Side Plank Exercises</h2>
                  
                  {/* Side Plank w/ thread the needle */}
                  <div className="bg-white rounded-xl p-6 mb-8 border border-[#E43636]">
                    <h3 className="text-2xl font-bold text-[#E43636] mb-4">Side Plank w/ thread the needle [right oblique]</h3>
                    <div className="mb-4">
                    ...
                    <div className="mb-4">
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-1">
                        <li><b>Exhale:</b> As you bring your left arm under your right oblique (follow your hands with your eyes and your head)</li>
                        <li><b>Inhale:</b> As you bring your left arm back up to the sky</li>
                        <li><b>Note:</b> The carriage does not move</li>
                      </ul>
                    </div>
                    <div className="mb-4">
                      <h4 className="text-lg font-semibold text-red-600 mb-2">DO NOT</h4>
                      <ul className="list-disc pl-6 text-[#E43636] space-y-1">
                        <li>DO NOT sink your ears into your shoulders or drop the bottom hip / oblique</li>
                      </ul>
                    </div>
                    <div className="mb-4">
                    ...
                    <div className="mb-4">
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-1">
                        <li><b>"Knee to Elbow":</b> Hold your side plank and extend your top arm and top leg out</li>
                        <li>Exhale as you bend your elbow to your knee</li>
                        <li>Inhale as you lengthen your arm and leg</li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-xl p-6 mb-8 border border-[#E43636]">
                    <h3 className="text-2xl font-bold text-[#E43636] mb-4">Reverse Side Plank w/ thread the needle [right oblique]</h3>
                    <div className="mb-4">
                      <h4 className="text-lg font-semibold text-[#E43636] mb-2">Position & Springs</h4>
                      <ul className="list-disc pl-6 text-[#000000] space-y-1">
                  ...
                  {/* Back Side Plank w/ thread the needle */}
                  <div className="bg-white rounded-xl p-6 mb-8 border border-[#E43636]">
                    <h3 className="text-2xl font-bold text-[#E43636] mb-4">Back Side Plank w/ thread the needle [right oblique]</h3>
                    <div className="mb-4">
                      <h4 className="text-lg font-semibold text-[#E43636] mb-2">Position & Springs</h4>
                      <ul className="list-disc pl-6 text-[#000000] space-y-1">
                    ...
                    <div className="mb-4">
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-1">
                        ...
                        <li>Come down to your right forearm over and against the back carriage strap and swing your feet off the right side of the front platform, stacking your knees</li>
                        <li>Left hand up to the sky, looking up at your hand</li>
                      </ul>
                    </div>
                    <div className="mb-4">
                    ...
                    <div className="mb-4">
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-1">
                        <li>1 white spring</li>
                        <li>Hold a Side Plank and thread the needle without moving the carriage as an alternative</li>
                        <li>Perform a "Back Side Kneeling Crunch" if you get tired</li>
                      </ul>
                    </div>
                    <div className="mb-4">
                      <h4 className="text-lg font-semibold text-[#E43636] mb-2">Intensifications</h4>
                  ...
                  {/* Back Reverse Side Plank w/ thread the needle */}
                  <div className="bg-white rounded-xl p-6 mb-8 border border-[#E43636]">
                    <h3 className="text-2xl font-bold text-[#E43636] mb-4">Back Reverse Side Plank w/ thread the needle [right oblique]</h3>
                    <div className="mb-4">
                      <h4 className="text-lg font-semibold text-[#E43636] mb-2">Position & Springs</h4>
                      <ul className="list-disc pl-6 text-[#000000] space-y-1">
                    ...
                    <div className="mb-4">
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-1">
                        ...
                        <li>Come down to your right forearm over and against the back platform strap and swing your feet off the right side of the carriage, stacking your knees</li>
                        <li>Left hand up to the sky, looking up at your hand</li>
                      </ul>
                    </div>
                    <div className="mb-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-white p-4 rounded-xl border border-[#E43636] hover:bg-[#E43636] hover:text-[#F6EFD2] transition-colors cursor-pointer">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="font-semibold text-black">Side Plank Guide PDF</p>
                    ...
                    <div className="bg-white p-4 rounded-xl border border-[#E43636] hover:bg-[#E43636] hover:text-[#F6EFD2] transition-colors cursor-pointer">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="font-semibold text-black">Thread the Needle Technique</p>
