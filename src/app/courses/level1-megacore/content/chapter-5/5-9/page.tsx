...
export default function Lesson59() {
  ...
  const lessonGoals = [
    'Master Back Light Squat (right leg) form and technique',
  ...
  const resources = [
    { name: 'Back Light Squat Guide PDF', type: 'pdf', size: '2.1 MB' },
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-5/5-9"
            nextLessonPath="/courses/level1-megacore/content/chapter-5/5-10"
          />
          {/* Main Content Area */}
          <div className="flex-1">
            ...
            >
              <div className="bg-black rounded-2xl overflow-hidden shadow-2xl">
                <iframe
                  width="100%"
                  height="500"
                  src="https://www.youtube.com/embed/nLKYFd4lcJA"
                  title="Back Light Squat (Right Leg) Tutorial"
                  frameBorder="0"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-[#E43636]">
              ...
              {activeTab === 'description' && (
                <div>
                  <h2 className="text-3xl font-bold text-[#E43636] mb-6">Back Light Squat (Right Leg)</h2>
                  {/* Lesson Goals */}
                  ...
                  <div className="space-y-8">
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Back Light Squat (Right Leg)</h3>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        ...
                        <li>Pull the carriage in using the short colored cable and place your left foot over and against the back carriage strap, and place your right foot over and against the back platform strap</li>
                        <li>Holding the short colored cable with both hands, allow the carriage to open until your feet are hip width apart</li>
                        <li>Turn your toes outwards an hour like the letter "V"</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Execution</h3>
                      <p className="text-[#000000] mb-4 italic">(holding and keeping the short colored cable in one place the whole time to keep the carriage from moving)</p>
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li><b>Inhale:</b> Send your hips back feeling a stretch in your hamstrings before bending the knees to lower down into a squat</li>
                        <li><b>Exhale:</b> Press through both heels to come up out of your squat</li>
                      </ul>
                    </section>
                    <section>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li>Go slower or move the foot on the carriage more towards the center</li>
                      </ul>
                    </section>
                    <section>
