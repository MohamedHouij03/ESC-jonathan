...
export default function Lesson510() {
  ...
  const lessonGoals = [
    'Master Back Standing Inner Thigh (right leg) form and technique',
    'Understand proper hip and knee alignment',
    'Learn safe and effective inner thigh exercise execution',
    'Practice holds and pulses for progression'
  ];

  const resources = [
    { name: 'Back Standing Inner Thigh Guide PDF', type: 'pdf', size: '2.1 MB' },
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-5/5-10"
          ...
          <div className="flex-1">
            ...
            >
              <div className="bg-black rounded-2xl overflow-hidden shadow-2xl">
                <iframe
                  ...
                  title="Back Standing Inner Thigh (Right Leg) Tutorial"
                  frameBorder="0"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-[#E43636]">
              ...
              {activeTab === 'description' && (
                <div>
                  <h2 className="text-3xl font-bold text-[#E43636] mb-6">Back Standing Inner Thigh (Right Leg)</h2>
                  {/* Lesson Goals */}
                  ...
                  <div className="space-y-8">
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Back Standing Inner Thigh (Right Leg)</h3>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        ...
                        <li>Holding the short colored cable in your left hand, allow the carriage to open until your feet are hip width apart</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Execution</h3>
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li><b>Exhale:</b> Press down both heels and squeeze both inner thighs to bring the carriage in (only pulling on the short colored cable up with your left hand as support to help move the carriage inwards)</li>
                        <li><b>Inhale:</b> Separate your feet evenly outwards hip width apart</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">DO NOT</h3>
                      <ul className="list-disc pl-6 text-[#E43636] space-y-2">
                        <li>DO NOT use the short cable as the primary way to move the carriage in</li>
                      </ul>
                    </section>
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        ...
                        <li>Perform a "Back Kneeling Inner Thigh" instead</li>
                      </ul>
                    </section>
                    <section>
                    ...
                    <section>
                      <div className="bg-gradient-to-r from-[#E43636] to-[#b82a2a] rounded-xl p-8 text-center text-white">
                        ...
                        <p className="text-lg mb-4">Congratulations! You have successfully completed all 10 lessons in Chapter 5: Back Platform & Well.</p>
                        ...
                        <ul className="text-left max-w-md mx-auto space-y-2">
                          ...
                          <li>• Back Single Leg Squat expertise (both legs)</li>
                          <li>• Advanced back platform techniques</li>
                          <li>• Back Light Squat mastery</li>
                          <li>• Back Standing Inner Thigh expertise</li>
                        </ul>
