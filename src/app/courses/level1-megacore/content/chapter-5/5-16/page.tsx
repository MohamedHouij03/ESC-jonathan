...
export default function Lesson516() {
  ...
  const lessonGoals = [
    'Master Back Reverse Floor Lunge (on the side of the carriage, left leg) form and technique',
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-5/5-16"
            nextLessonPath="/courses/level1-megacore/content/chapter-6/6-1"
          />
          {/* Main Content Area */}
          <div className="flex-1">
            ...
            >
              <div className="bg-black rounded-2xl overflow-hidden shadow-2xl">
                <iframe
                  ...
                  title="Back Reverse Floor Lunge (on the side of the carriage, left leg) Tutorial"
                  frameBorder="0"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-[#E43636]">
              ...
              {activeTab === 'description' && (
                <div>
                  <h2 className="text-3xl font-bold text-[#E43636] mb-6">Back Reverse Floor Lunge (on the side of the carriage, left leg)</h2>
                  {/* Lesson Goals */}
                  ...
                  <div className="space-y-8">
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Back Reverse Floor Lunge (on the side of the carriage, left leg)</h3>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li>Starting at the right side of the carriage facing the front platform, turn around and walk to the back platform</li>
                        <li>Pull the carriage in with your right hand and tuck your right toes over and behind the front carriage strap</li>
                        <li>Keep your left foot on the floor to the side of the reformer.</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Execution</h3>
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li><b>Inhale:</b> Lower down and hinge from the hips forward</li>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#E43636] space-y-2">
                        ...
                        <li>DO NOT allow the right hip to be pulled back by the carriage.</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Modifications</h3>
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li>Take one step back towards the front platform with the foot on the floor to decrease tension.</li>
                        <li>Come down to your knees, shins, and shoelaces onto the carriage rather than having your toes on the carriage</li>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li>Go slower or take one step forward towards the back platform with the foot on the floor to increase tension.</li>
                      </ul>
                    </section>
                    <section>
                    ...
                    <section>
                      <div className="bg-gradient-to-r from-[#E43636] to-[#b82a2a] rounded-xl p-8 text-center text-white">
                        ...
                        <p className="text-lg mb-4">Congratulations! You have successfully completed all 16 lessons in Chapter 5: Back Platform & Well.</p>
                        <p className="text-lg">You have mastered advanced back platform techniques, well exercises, and floor lunge variations. Your dedication to learning proper form and technique is commendable!</p>
                      </div>
                    </section>
                  </div>
                </div>
