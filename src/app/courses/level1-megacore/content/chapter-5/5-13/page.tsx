...
export default function Lesson513() {
  ...
  const lessonGoals = [
    ...
    'Master proper form and alignment',
    'Understand exercise progression',
    'Practice safe execution methods'
  ];

  const resources = [
    { name: 'Back Platform Guide PDF', type: 'pdf', size: '2.1 MB' },
    { name: 'Exercise Progression Chart', type: 'pdf', size: '1.8 MB' },
    { name: 'Form Checklist', type: 'pdf', size: '0.9 MB' }
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-5/5-13"
            nextLessonPath="/courses/level1-megacore/content/chapter-5/5-14"
          />
          {/* Main Content Area */}
          <div className="flex-1">
            ...
            >
              <div className="bg-black rounded-2xl overflow-hidden shadow-2xl">
                <iframe
                  ...
                  title="Chapter 5 - Lesson 13 Tutorial"
                  frameBorder="0"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-[#E43636]">
              ...
              {activeTab === 'description' && (
                <div>
                  <h2 className="text-3xl font-bold text-[#E43636] mb-6">Chapter 5 - Lesson 13</h2>
                  {/* Lesson Goals */}
