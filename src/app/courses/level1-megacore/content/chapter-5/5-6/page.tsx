...
export default function Lesson56() {
  ...
  const [completedLessons, setCompletedLessons] = useState([1, 2, 3, 4, 5, 6]);
  ...
  const lessonGoals = [
    'Master Back Single Leg Squat (right leg) form and technique',
    'Understand proper hip and knee alignment',
    'Learn safe and effective squat execution',
    'Practice holds and pulses for progression'
  ];

  const resources = [
    { name: 'Back Single Leg Squat Guide PDF', type: 'pdf', size: '2.1 MB' },
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-5/5-6"
            nextLessonPath="/courses/level1-megacore/content/chapter-5/5-7"
          />
          {/* Main Content Area */}
          <div className="flex-1">
            ...
            >
              <div className="bg-black rounded-2xl overflow-hidden shadow-2xl">
                <iframe
                  width="100%"
                  height="500"
                  src="https://www.youtube.com/embed/LSNXzamLkuI"
                  title="Back Single Leg Squat (Right Leg) Tutorial"
                  frameBorder="0"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-[#E43636]">
              ...
              {activeTab === 'description' && (
                <div>
                  <h2 className="text-3xl font-bold text-[#E43636] mb-6">Back Single Leg Squat (Right Leg)</h2>
                  {/* Lesson Goals */}
                  ...
                  <div className="space-y-8">
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Back Single Leg Squat (Right Leg)</h3>
                      <p className="text-[#000000] mb-4">In the back, facing sideways</p>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li>Standing inside of the well, facing the back platform, turn to your left</li>
                        <li>Your right hand will pick up the short colored cable and then stand up on the back platform</li>
                        <li>Pull the carriage in using the short colored cable and bring your right foot all the way forward with your left toes diagonally back on the carriage, toes down and heels up</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Execution</h3>
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li><b>Inhale:</b> Send your hips back feeling a stretch in your hamstrings before bending the knees to lower down</li>
                        <li><b>Exhale:</b> Press through your right heel to come up</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">DO NOT</h3>
                      <ul className="list-disc pl-6 text-[#E43636] space-y-2">
                        <li>DO NOT collapse your knee inward towards your midline or belly button</li>
                        <li>DO NOT allow your right knee to pass your toes as you go down</li>
                      </ul>
                    </section>
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        ...
                        <li>Hold the short colored cable with two hands</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Intensifications</h3>
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li>Go slower or move the foot on the carriage closer to the center of the carriage</li>
                      </ul>
                    </section>
                    <section>
                    ...
                    {/* Chapter 5 Complete Mastery Achievement */}
                    <section>
                      <div className="bg-gradient-to-r from-[#E43636] to-[#b82a2a] rounded-xl p-8 text-center text-white">
                        <h3 className="text-2xl font-bold mb-4">🎉 Chapter 5 Complete Mastery Achievement! 🎉</h3>
                        <p className="text-lg mb-4">Congratulations! You have successfully completed all 6 lessons in Chapter 5: Back Platform & Well.</p>
                        <p className="text-lg mb-4">You have mastered:</p>
                        <ul className="text-left max-w-md mx-auto space-y-2">
                          <li>• Back Reverse Platform Lunge techniques</li>
                          <li>• Advanced back platform exercises</li>
                          <li>• Back Kneeling Inner Thighs mastery</li>
                          <li>• Back Carriage Lunge proficiency</li>
                          <li>• Back Single Leg Squat expertise</li>
                        </ul>
                        <p className="text-lg mt-4">You are now ready to continue your Level 1 Megacore journey!</p>
                      </div>
                    </section>
                  </div>
                </div>
