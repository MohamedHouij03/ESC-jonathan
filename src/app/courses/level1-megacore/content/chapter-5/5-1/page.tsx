...
export default function Lesson51() {
  ...
  const lessonGoals = [
    'Master Back Reverse Platform Lunge (left leg) form and technique',
  ...
  const resources = [
    { name: 'Back Reverse Platform Lunge Guide PDF', type: 'pdf', size: '2.1 MB' },
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-5/5-1"
            nextLessonPath="/courses/level1-megacore/content/chapter-5/5-2"
          />
          {/* Main Content Area */}
          <div className="flex-1">
            ...
            >
              <div className="bg-black rounded-2xl overflow-hidden shadow-2xl">
                <iframe
                  width="100%"
                  height="500"
                  src="https://www.youtube.com/embed/lGa0j4psODo"
                  title="Back Reverse Platform Lunge (Left Leg) Tutorial"
                  frameBorder="0"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-[#E43636]">
              ...
              {activeTab === 'description' && (
                <div>
                  <h2 className="text-3xl font-bold text-[#E43636] mb-6">Back Reverse Platform Lunge (Left Leg)</h2>
                  {/* Lesson Goals */}
                  ...
                  <div className="space-y-8">
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Back Reverse Platform Lunge (Left Leg)</h3>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li>Start by standing in the well, facing the back platform</li>
                        <li>Pick up the short colored cables and stand up on the back platform</li>
                        <li>Bicep curl with the short colored cables to pull the carriage in</li>
                        <li>The left foot stays on the back platform & the right foot anchors behind the back carriage strap, toes down & heels up</li>
                        <li>Your right leg should be straight with a slight bend in your knee</li>
                      </ul>
                    </section>
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        ...
                        <li><b>Exhale:</b> Press through your left foot to come up slowly, lifting the chest as you rise</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">DO NOT</h3>
                      <ul className="list-disc pl-6 text-[#E43636] space-y-2">
                        <li>DO NOT let the knee move forward as you come up or back as you come down</li>
                        <li>DO NOT lean back as you rise</li>
                        <li>DO NOT let the knee collapse inwards towards the midline or belly button</li>
                        <li>DO NOT pull with the cable first to come up. Use your target leg first and short colored cables second as support</li>
                        <li>DO NOT shrug your shoulders up when performing a bicep curl with the short cables to come up</li>
                      </ul>
                    </section>
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        ...
                        <li>To take a break, step forward onto the back platform and relax your arms</li>
                      </ul>
                    </section>
                    <section>
                    ...
                    <section>
                      ...
                      <div className="bg-white p-6 rounded-xl border border-[#E43636]">
                        ...
                        <p className="text-[#000000]">Meet me halfway down and hold</p>
