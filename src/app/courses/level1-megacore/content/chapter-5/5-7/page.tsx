...
export default function Lesson57() {
  ...
  const lessonGoals = [
    'Master Back Single Leg Squat (left leg) form and technique',
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-5/5-7"
            nextLessonPath="/courses/level1-megacore/content/chapter-5/5-8"
          />
          {/* Main Content Area */}
          <div className="flex-1">
            ...
            >
              <div className="bg-black rounded-2xl overflow-hidden shadow-2xl">
                <iframe
                  ...
                  title="Back Single Leg Squat (Left Leg) Tutorial"
                  frameBorder="0"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-[#E43636]">
              ...
              {activeTab === 'description' && (
                <div>
                  <h2 className="text-3xl font-bold text-[#E43636] mb-6">Back Single Leg Squat (Left Leg)</h2>
                  {/* Lesson Goals */}
                  ...
                  <div className="space-y-8">
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Back Single Leg Squat (Left Leg)</h3>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li>Standing inside of the well, facing the back platform, turn to your right</li>
                        <li>Your left hand will pick up the short colored cable and then stand up on the back platform</li>
                        <li>Pull the carriage in using the short colored cable and bring your left foot all the way forward with your right toes diagonally back on the carriage, toes down and heels up</li>
                      </ul>
                    </section>
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        ...
                        <li><b>Exhale:</b> Press through your left heel to come up</li>
                      </ul>
                    </section>
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#E43636] space-y-2">
                        ...
                        <li>DO NOT allow your left knee to pass your toes as you go down</li>
                      </ul>
                    </section>
                    <section>
