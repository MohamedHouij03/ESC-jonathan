...
export default function Lesson52() {
  ...
  const lessonGoals = [
    'Learn advanced back platform techniques',
    'Understand proper form and alignment',
    'Master exercise execution and safety',
    'Build strength and coordination'
  ];

  const resources = [
    { name: 'Back Platform Guide PDF', type: 'pdf', size: '2.0 MB' },
    { name: 'Exercise Progression Chart', type: 'pdf', size: '1.5 MB' },
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-5/5-2"
            nextLessonPath="/courses/level1-megacore/content/chapter-5/5-3"
          />
          {/* Main Content Area */}
          <div className="flex-1">
            ...
            >
              <div className="bg-black rounded-2xl overflow-hidden shadow-2xl">
                <iframe
                  width="100%"
                  height="500"
                  src="https://www.youtube.com/embed/wp3OAE77iIg"
                  title="Chapter 5 - Lesson 2 Tutorial"
                  frameBorder="0"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-[#E43636]">
              ...
              {activeTab === 'description' && (
                <div>
                  <h2 className="text-3xl font-bold text-[#E43636] mb-6">Chapter 5 - Lesson 2</h2>
                  {/* Lesson Goals */}
                  ...
                  <div className="space-y-8">
                    <section>
                      ...
                      <p className="text-[#000000] mb-4">This lesson focuses on advanced back platform techniques and proper form execution.</p>
                      <div className="bg-white p-6 rounded-xl border border-[#E43636]">
                        <p className="text-[#000000] text-center text-lg">Watch the video above for detailed instructions and demonstrations of the exercise techniques covered in this lesson.</p>
                      </div>
                    </section>
                  </div>
                </div>
