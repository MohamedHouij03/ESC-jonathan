...
export default function Lesson53() {
  ...
  const lessonGoals = [
    'Master Back Kneeling Inner Thighs (right leg) form and technique',
  ...
  const resources = [
    { name: 'Back Kneeling Inner Thighs Guide PDF', type: 'pdf', size: '2.0 MB' },
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-5/5-3"
            nextLessonPath="/courses/level1-megacore/content/chapter-5/5-4"
          />
          {/* Main Content Area */}
          <div className="flex-1">
            ...
            >
              <div className="bg-black rounded-2xl overflow-hidden shadow-2xl">
                <iframe
                  width="100%"
                  height="500"
                  src="https://www.youtube.com/embed/n0Sjbk6UkhU"
                  title="Back Kneeling Inner Thighs (Right Leg) Tutorial"
                  frameBorder="0"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-[#E43636]">
              ...
              {activeTab === 'description' && (
                <div>
                  <h2 className="text-3xl font-bold text-[#E43636] mb-6">Back Kneeling Inner Thighs (Right Leg)</h2>
                  {/* Lesson Goals */}
                  ...
                  <div className="space-y-8">
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Back Kneeling Inner Thighs (Right Leg)</h3>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li>Starting in the well facing the back platform</li>
                        <li>Turn to your left and pull the carriage in keeping it in your left hand</li>
                        <li>Your right hand will hold onto the handlebar to place your right knee over and against the back platform strap and then place your left knee over and against the back carriage strap</li>
                        <li>Squeeze your inner thighs together to connect the carriage and back platform</li>
                        <li>Hands can be on your hips, behind your back, or outwards like wings</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Execution</h3>
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li>(Keep weight evenly distributed into both legs)</li>
                        <li><b>Inhale:</b> Start to separate the knees apart to open the carriage</li>
                        <li><b>Exhale:</b> Squeeze both inner thighs equally to close the carriage</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">DO NOT</h3>
                      <ul className="list-disc pl-6 text-[#E43636] space-y-2">
                        <li>DO NOT go so far out that you overcompensate by using your knees more than your inner thighs</li>
                        <li>DO NOT use more of the leg attached to the carriage to close the carriage</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Modifications</h3>
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li>Turn the black handle bar in front of you to face the front platform so that it's in front of you for support</li>
                        <li>Use the short colored cables for support to pull the carriage in if needed</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Intensifications</h3>
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li>Go slower or use 2 gray springs</li>
                      </ul>
                    </section>
                    <section>
                      ...
                      <div className="bg-white p-6 rounded-xl border border-[#E43636]">
                        ...
                        <p className="text-[#000000]">Meet me halfway out</p>
