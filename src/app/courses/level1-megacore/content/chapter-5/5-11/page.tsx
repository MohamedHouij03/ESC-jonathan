...
export default function Lesson511() {
  ...
  const lessonGoals = [
    'Master Well Lunge (right leg) form and technique',
  ...
  const resources = [
    { name: 'Well Lunge Guide PDF', type: 'pdf', size: '2.1 MB' },
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-5/5-11"
            nextLessonPath="/courses/level1-megacore/content/chapter-5/5-12"
          />
          {/* Main Content Area */}
          <div className="flex-1">
            ...
            >
              <div className="bg-black rounded-2xl overflow-hidden shadow-2xl">
                <iframe
                  width="100%"
                  height="500"
                  src="https://www.youtube.com/embed/JGd6aL8i-uI"
                  title="Well Lunge (Right Leg) Tutorial"
                  frameBorder="0"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-[#E43636]">
              ...
              {activeTab === 'description' && (
                <div>
                  <h2 className="text-3xl font-bold text-[#E43636] mb-6">Well Lunge (Right Leg)</h2>
                  {/* Lesson Goals */}
                  ...
                  <div className="space-y-8">
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Well Lunge (Right Leg)</h3>
                      <p className="text-[#000000] mb-4">In the well, facing back</p>
                    ...
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        ...
                        <li>Turn to your left and pull the carriage in with your left hand to anchor your left knee over and against the back carriage strap.</li>
                        <li>Keep your right foot down in the well.</li>
                      </ul>
                    </section>
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        ...
                        <li><b>Exhale:</b> Press through your foot in the well to come up slowly, lifting the chest as you rise</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">DO NOT</h3>
                      <ul className="list-disc pl-6 text-[#E43636] space-y-2">
                        <li>DO NOT let the knee move forward as you come up or back as you go down.</li>
                        <li>DO NOT press your knee down into the carriage to come up.</li>
                        <li>DO NOT let the knee collapse inward towards the belly button.</li>
                        <li>DO NOT allow your hip to be pulled back by your knee attached to the carriage.</li>
                      </ul>
                    </section>
                    <section>
                      ...
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        ...
                        <li>Take one step back with the foot in the well closer to the front platform</li>
                      </ul>
                    </section>
                    <section>
                      <h3 className="text-2xl font-bold text-[#E43636] mb-4">Intensifications</h3>
                      <ul className="list-disc pl-6 text-[#000000] space-y-2">
                        <li>Go slower or move the foot in the well forward closer to the back platform.</li>
                      </ul>
                    </section>
                    <section>
