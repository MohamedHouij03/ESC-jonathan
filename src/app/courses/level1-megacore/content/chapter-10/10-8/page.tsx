...
export default function Lesson108() {
  ...
  // Tab content data
  const resources = [
    { name: "Course Completion Certificate (PDF)", size: "1.2 MB" },
    { name: "Final Assessment Guidelines (PDF)", size: "2.4 MB" },
    { name: "Graduation Ceremony Information (PDF)", size: "1.8 MB" },
  ];
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-600">Chapter 10 - Lesson 8</p>
              </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50">
      ...
      <div className="flex">
        ...
        <div className="pl-4 pt-4">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-10/10-8"
            nextLessonPath="/courses/level1-megacore/content/chapter-10/10-9"
          />
        </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-8 lg:pl-20 lg:pt-16">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-8">
              <h1 className="text-4xl font-bold text-[#E43636] mb-4">Lesson 10-8</h1>
              <p className="text-lg text-gray-700 font-medium">
                Course Completion & Certification: Final Steps
              </p>
            </div>
            ...
            >
              ...
              <div className="relative w-full h-0 pb-[56.25%] rounded-lg overflow-hidden shadow-lg">
                <iframe
                  ...
                  src="https://www.youtube.com/embed/I8NL9gCsHzA"
                  title="Course Completion & Certification Tutorial"
                  frameBorder="0"
            ...
            >
              ...
              >
                ...
                {activeTab === "description" && (
                  <div>
                    <p className="text-[#000000] text-center text-lg">
                      Watch the video above for the complete lesson content.
                    </p>
                  </div>
                )}
