...
export default function Lesson125() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          <CourseNavigation 
            currentLessonPath="/courses/level1-megacore/content/chapter-12/12-5"
            nextLessonPath="/courses/level1-megacore/content/chapter-12/12-6"
          />
          {/* Main Content Area */}
          <div className="flex-1">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-[#E43636]">
              ...
              {activeTab === 'description' && (
                <div>
                  <h2 className="text-3xl font-bold text-[#E43636] mb-6">Lesson 12-5</h2>
                  {/* Lesson Goals */}
