...
const BeginnerFriendlyRoutine5Page = () => {
      ...
      <div className="relative h-[60vh] bg-[#E43636]">
        ...
        <div className="relative h-full flex items-center justify-center text-center px-4">
          <div className="max-w-4xl">
            ...
            >
              A comprehensive workout designed for beginners (pending!!!)
            </motion.p>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-8">
          ...
          >
            ...
            <ul className="list-disc list-inside text-[#000000] space-y-2">
              ...
              <li>Side Kick or Bungee</li>
              <li>Donkey Kick or Black Widow</li>
            </ul>
          </motion.div>
...
export default BeginnerFriendlyRoutine5Page; 