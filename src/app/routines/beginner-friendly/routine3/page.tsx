  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        >
          <h2 className="text-3xl font-bold text-gray-800 mb-4">Top 3 to inform the class before starting:</h2>
        ...
        <div className="space-y-8">
          ...
          >
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Abs [10 min]</h2>
            <ul className="list-disc list-inside text-gray-600 space-y-2">
              <li>Ab Wheel</li>
              <li>Saw</li>
              <li>Plank to Pike</li>
          ...
          <motion.div 
            ...
            className="bg-white rounded-lg shadow-lg p-8"
          >
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Legs [9 min x 2 = 18 min] - Legs back to back</h2>
            <ul className="list-disc list-inside text-gray-600 space-y-2">
          ...
          <motion.div 
            ...
            className="bg-white rounded-lg shadow-lg p-8"
          >
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Oblique [8 min]</h2>
            <ul className="list-disc list-inside text-gray-600 space-y-2">
          ...
          <motion.div 
            ...
            className="bg-white rounded-lg shadow-lg p-8"
          >
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Upper Body [6 min]</h2>
            <p className="text-gray-600 mb-4">(2-3 white springs)</p>
            <p className="text-gray-600 mb-4">(handle bars at the back of the machine turned inwards to face one another)</p>
            <ul className="list-disc list-inside text-gray-600 space-y-2">
          ...
          <motion.div 
            ...
            className="bg-white rounded-lg shadow-lg p-8"
          >
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Core Finisher</h2>
            <ul className="list-disc list-inside text-gray-600 space-y-2">
